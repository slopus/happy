...
export type PermissionMode = 'default' | 'acceptEdits' | 'bypassPermissions' | 'plan' | 'read-only' | 'safe-yolo' | 'yolo' | 'zen';
...
const modeConfig = {
    ...
    'zen': {
        label: 'Zen',
        icon: 'leaf' as const,
        description: 'Auto-approve, hide code'
    },
};

const modeOrder: PermissionMode[] = ['default', 'acceptEdits', 'plan', 'bypassPermissions', 'zen'];
