...
import { storeTempData, NewSessionData } from '@/utils/tempDataStore';
import { AgentPreset } from './model/presets';
...
export const ZenHome = () => {
    ...
    const handlePresetSelect = React.useCallback((preset: AgentPreset) => {
        const sessionData: NewSessionData = {
            prompt: 'Привет!',
            agentType: 'claude',
            customSystemPrompt: preset.systemRole,
            presetId: preset.id,
        };
