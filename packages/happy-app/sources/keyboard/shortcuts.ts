...
// Menu actions that carry no keyboard chord. SESSION_ACTION_SHORTCUTS stays
// keyed only by the chord-bearing ids, so use getSessionActionShortcut() to look
// a chord up from an id of this wider type.
export type SessionActionId = SessionActionShortcutId | 'mark-unread';
