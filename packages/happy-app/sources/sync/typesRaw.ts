...
const rawToolResultContentSchema = z.object({
    ...
    permissions: z.object({
        ...
        mode: z.enum(['default', 'acceptEdits', 'bypassPermissions', 'plan', 'read-only', 'safe-yolo', 'yolo', 'zen']).optional(),
    ...
    if (raw.role === 'user') {
        return {
            ...
            content: {
                ...
                ...(raw.content.images && raw.content.images.length > 0 ? { images: raw.content.images } : {}),
                ...(raw.content.documents && raw.content.documents.length > 0 ? { documents: raw.content.documents } : {}),
            },
            isSidechain: false,
            meta: raw.meta,
        };
