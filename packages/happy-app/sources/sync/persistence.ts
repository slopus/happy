...
export type NewSessionAgentType = 'claude' | 'codex' | 'gemini' | 'hermes' | 'openclaw';
...
export function loadNewSessionDraft(): NewSessionDraft | null {
    ...
    try {
        ...
        const agentType: NewSessionAgentType = parsed.agentType === 'codex' || parsed.agentType === 'gemini' || parsed.agentType === 'hermes' || parsed.agentType === 'openclaw'
            ? parsed.agentType
            : 'claude';
