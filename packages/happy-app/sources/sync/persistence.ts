...
export type NewSessionAgentType = 'claude' | 'codex' | 'gemini' | 'openclaw' | 'agy' | 'opencode' | 'rig';
...
export function loadNewSessionDraft(): NewSessionDraft | null {
    ...
    try {
        ...
        const agentType: NewSessionAgentType = parsed.agentType === 'codex' || parsed.agentType === 'gemini' || parsed.agentType === 'openclaw' || parsed.agentType === 'agy' || parsed.agentType === 'opencode' || parsed.agentType === 'rig'
            ? parsed.agentType
            : 'claude';
