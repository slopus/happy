...
export type NewSessionAgentType = 'claude' | 'codex' | 'gemini' | 'openclaw' | 'agy' | 'rig' | 'hermes' | 'crush';
...
export function loadNewSessionDraft(): NewSessionDraft | null {
    ...
    try {
        ...
        const agentType: NewSessionAgentType = parsed.agentType === 'codex' || parsed.agentType === 'gemini' || parsed.agentType === 'openclaw' || parsed.agentType === 'agy' || parsed.agentType === 'rig' || parsed.agentType === 'hermes' || parsed.agentType === 'crush'
            ? parsed.agentType
            : 'claude';
