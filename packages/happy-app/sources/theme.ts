...
export const darkCarbonTheme = createDarkVariant({
    ...
    groupped: { background: '#141414', chevron: '#A0A0A0', sectionTitle: '#A0A0A0', item: '#262626', itemPressed: '#333333' },
...
export const darkWarmTheme = createDarkVariant({
    ...
    groupped: { background: '#151008', chevron: '#A89585', sectionTitle: '#A89585', item: '#2A2219', itemPressed: '#3A3028' },
...
export const darkOceanTheme = createDarkVariant({
    ...
    groupped: { background: '#090D13', chevron: '#8B949E', sectionTitle: '#8B949E', item: '#161B22', itemPressed: '#1B2332' },
...
export const darkOledTheme = createDarkVariant({
    ...
    groupped: { background: '#000000', chevron: '#999999', sectionTitle: '#999999', item: '#1A1A1A', itemPressed: '#2A2A2A' },
