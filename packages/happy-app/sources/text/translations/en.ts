...
export const en: TranslationStructure = {
    ...
    relationshipAdvisorPlugin: {
        ...
        encryptionNotice: 'Your configuration, including the API key, is encrypted and stored on the Paws server. After saving, the key is never returned to the app.',
        apiKey: 'API Key',
