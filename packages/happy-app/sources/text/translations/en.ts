...
export const en: TranslationStructure = {
    ...
    deviceEnvironment: {
        ...
        actionEgoOnboard: 'Complete Ego CLI onboarding', actionWranglerInstall: ({ version }: { version: string }) => `Install Wrangler ${version}`, actionWranglerUpgrade: ({ from, version }: { from: string; version: string }) => `Upgrade Wrangler ${from} → ${version}`, actionWranglerAuthenticate: 'Sign in to Cloudflare with Wrangler', actionCloudflaredInstall: ({ version }: { version: string }) => `Install cloudflared ${version}`, actionCloudflaredUpgrade: ({ from, version }: { from: string; version: string }) => `Upgrade cloudflared ${from} → ${version}`, actionCloudflaredAuthenticate: 'Open Cloudflare tunnel login', confirmToolTitle: ({ component }: { component: string }) => `Align ${component}?`, confirmToolMessage: ({ actions }: { actions: string }) => `Review the exact action for each machine:\n\n${actions}\n\nInstalls and upgrades only use the verified package owner. Sign-in and onboarding open the official interactive flow on that machine. Credentials are never copied between machines.`,
    ...
    interactivePreviews: {
        title: 'Temporary previews', provider: 'Cloudflare', connection: 'Cloudflare hosting account', loading: 'Loading connection…',
        ...
        unavailable: 'Cloud hosting is unavailable on this Happy Server. Anonymous temporary tunnels are still available.', disconnected: 'Not connected',
        connected: ({ name }: { name: string }) => `Connected to ${name}`, project: 'Preview project',
        connect: 'Connect with API Token', reconnect: 'Update API Token', disconnect: 'Disconnect cloud hosting',
        disconnectTitle: 'Disconnect Cloudflare hosting?', disconnectBody: 'New hosted previews will stop immediately. Existing hosted previews are removed when possible. Anonymous temporary tunnels remain available.',
        disconnectWarning: 'Some hosted previews could not be removed. Delete them manually in Cloudflare and revoke the API Token.',
        popupBlocked: 'Configure cloud hosting with your Cloudflare Account ID and scoped API Token.', safeError: 'Unable to update temporary previews. Please retry.', retry: 'Retry',
    ...
    sidebarLists: {
        ...
        organizeSession: 'Organize session', listName: 'List name', listNamePlaceholder: 'For example: Happy', duplicateListName: 'A list with this name already exists.',
        listType: 'List type', color: 'Color', defaultMachine: 'Default machine', defaultDirectory: 'Default directory', directoryPlaceholder: '~/projects/happy',
        defaultAgent: 'Default Agent', noPreset: 'No preset', agentPrompt: 'Agent prompt', agentPromptPlaceholder: 'Prompt applied when starting from this Agent list',
        ...
        tagActions: 'Tag actions', groupedByList: 'Grouped by list', tagDetailsMeta: ({ sessionCount, listCount }: { sessionCount: number; listCount: number }) => `${sessionCount} sessions · ${listCount} lists`, deleteTag: 'Delete tag',
    ...
    agents: {
        ...
        imageStylePhotoIllustrationDiptychLakesideHint: 'Pair one lakeside photo with a radically simplified geometric rendering of the same scene. Preserve the boardwalk curve, dock rhythm, boat position, shoreline, horizon, and mountain profile using source-derived blue, green, coral, and warm-ivory color fields.',
