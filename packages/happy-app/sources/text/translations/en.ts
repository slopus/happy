...
export const en: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        renameSessionDescription: 'Set a custom name for this session',
        renameSessionClear: 'Clear to reset to auto-generated name',
        ...
        restartSessionConfirm: 'Restart this session? It will be archived and resumed.',
        ...
        archiveAndDelete: 'Archive and delete this session?',
