...
export const zhHans: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        renameSession: '重命名',
        renameSessionDescription: '为此会话设置自定义名称',
        renameSessionClear: '清除以重置为自动生成的名称',
        sessionName: '会话名称',
        metadata: '元数据',
        host: '主机',
        path: '路径',
        ...
        restartSession: '重启',
        restartSessionConfirm: '重启此会话？它将被归档并恢复。',
        archiveAndDelete: '归档并删除此会话？',
