...
export const zhHans: TranslationStructure = {
    ...
    taskManager: {
        ...
        newTask: '新建任务',
        machine: '机器',
        noMachinesOnline: '没有在线的机器。请先启动daemon。',
        agentType: '代理类型',
        noAgentsOnMachine: '此机器上未检测到代码代理。',
        model: '模型',
        creating: '创建中...',
        saving: '保存中...',
        ...
        planHint: '代理先提出计划',
        yoloMode: 'YOLO Mode',
        yoloHint: '跳过所有权限提示 (--dangerously-skip-permissions)',
        taskPrompt: '代理应该做什么？',
        taskPromptPlaceholder: '描述任务...',
        createPlan: '创建计划',
        createTask: '创建任务',
        taskNotFound: '未找到任务',
        agentWorking: '代理工作中...',
        ...
        agentLabel: '代理',
        complete: '已完成',
        noSession: '暂无会话。等待代理启动...',
        waitingMessages: '等待消息...',
        chatPlaceholder: '向代理发送消息... (Cmd+Enter 发送)',
        send: '发送',
        you: '你',
        name: '名称',
    },
