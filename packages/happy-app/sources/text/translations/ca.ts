...
export const ca: TranslationStructure = {
    ...
    relationshipAdvisorPlugin: {
        ...
        apiKeyPlaceholder: 'Introdueix la clau de l’API',
        baseUrl: 'URL base',
        baseUrlPlaceholder: 'https://api.example.com/v1',
        model: 'Model',
        modelPlaceholder: 'Nom del model',
        testConnection: 'Prova la connexió',
        testConnectionSubtitle: 'Envia una sol·licitud mínima amb la configuració actual sense desar-la',
