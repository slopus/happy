...
export const ca: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        renameSession: 'Reanomena',
        renameSessionDescription: 'Estableix un nom personalitzat per a aquesta sessió',
        renameSessionClear: 'Esborra per restablir el nom generat automàticament',
        ...
        restartSessionConfirm: 'Reiniciar aquesta sessió? S\'arxivarà i es reprendrà.',
        archiveAndDelete: 'Arxivar i eliminar aquesta sessió?',
