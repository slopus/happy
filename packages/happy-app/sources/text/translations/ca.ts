...
export const ca: TranslationStructure = {
    ...
    taskManager: {
        selectTask: 'Selecciona una tasca per veure els detalls',
        machines: 'Màquines',
        noMachines: 'No hi ha màquines connectades',
        agents: 'Agents',
        noAgents: 'No hi ha agents configurats',
        projects: 'Projectes',
        noProjects: 'Encara no hi ha projectes',
        tasks: 'Tasques',
        ...
        newTask: 'Nova tasca',
        machine: 'Màquina',
        noMachinesOnline: 'No hi ha màquines en línia. Inicia un daemon primer.',
        agentType: "Tipus d'agent",
        noAgentsOnMachine: "No s'han detectat agents de codi en aquesta màquina.",
        model: 'Model',
        creating: 'Creant...',
        saving: 'Desant...',
        githubRepo: 'Repositori de GitHub',
        description: 'Descripció',
        descriptionPlaceholder: 'De què tracta aquest projecte?',
        project: 'Projecte',
        agent: 'Agent',
        mode: 'Mode',
        execute: 'Executar',
        executeHint: "L'agent actua immediatament",
        plan: 'Pla',
        planHint: "L'agent proposa un pla primer",
        yoloMode: 'YOLO Mode',
        yoloHint: 'Omet totes les sol·licituds de permisos (--dangerously-skip-permissions)',
        taskPrompt: "Què ha de fer l'agent?",
        taskPromptPlaceholder: 'Descriu la tasca...',
        createPlan: 'Crear pla',
        createTask: 'Crear tasca',
        taskNotFound: 'Tasca no trobada',
        agentWorking: 'Agent treballant...',
        agentDone: 'Agent ha acabat',
        agentWaiting: 'Esperant',
        agentLabel: 'Agent',
        complete: 'Completat',
        noSession: "Encara no hi ha sessió. Esperant que l'agent comenci...",
        waitingMessages: 'Esperant missatges...',
        chatPlaceholder: "Envia un missatge a l'agent... (Cmd+Enter per enviar)",
        send: 'Enviar',
        you: 'Tu',
        name: 'Nom',
    },
