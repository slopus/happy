...
export const ca: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        worktree: {
            ...
            createPRConfirm: ({ branch }: { branch: string }) => `Crear un Pull Request per a la branca "${branch}"?`,
            ...
            mergeBranchSubtitle: 'Fusionar la branca del worktree amb la branca base',
            mergeConfirm: ({ branch }: { branch: string }) => `Fusionar "${branch}" amb la branca base?`,
            ...
            cleanupSubtitle: 'Eliminar el directori del worktree (la branca es conserva)',
            cleanupConfirm: 'Eliminar el worktree? La branca es conservarà per seguretat.',
            ...
            archiveAndCleanup: 'Arxivar i netejar',
            ...
            reviewSelectAgent: 'Seleccionar revisor',
            ...
            reviewDiffFailed: "Error en obtenir el diff del PR",
