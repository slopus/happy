...
export const zhHant: TranslationStructure = {
    ...
    taskManager: {
        ...
        newTask: '新建任務',
        machine: '機器',
        noMachinesOnline: '沒有線上的機器。請先啟動daemon。',
        agentType: '代理類型',
        noAgentsOnMachine: '此機器上未偵測到程式碼代理。',
        model: '模型',
        creating: '建立中...',
        saving: '儲存中...',
        ...
        planHint: '代理先提出計畫',
        yoloMode: 'YOLO Mode',
        yoloHint: '跳過所有權限提示 (--dangerously-skip-permissions)',
        taskPrompt: '代理應該做什麼？',
        taskPromptPlaceholder: '描述任務...',
        createPlan: '建立計畫',
        createTask: '建立任務',
        taskNotFound: '未找到任務',
        agentWorking: '代理工作中...',
        ...
        agentLabel: '代理',
        complete: '已完成',
        noSession: '暫無工作階段。等待代理啟動...',
        waitingMessages: '等待訊息...',
        chatPlaceholder: '向代理傳送訊息... (Cmd+Enter 傳送)',
        send: '傳送',
        you: '你',
        name: '名稱',
    },
