...
export const it: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        worktree: {
            ...
            createPRConfirm: ({ branch }: { branch: string }) => `Creare un Pull Request per il branch "${branch}"?`,
            ...
            mergeBranchSubtitle: 'Unisci il branch del worktree al branch base',
            mergeConfirm: ({ branch }: { branch: string }) => `Unire "${branch}" al branch base?`,
            ...
            cleanupSubtitle: 'Elimina la directory del worktree (il branch viene preservato)',
            cleanupConfirm: 'Rimuovere il worktree? Il branch verrà preservato per sicurezza.',
            ...
            archiveAndCleanup: 'Archivia e pulisci',
    ...
    settingsVoice: {
        ...
        providerElevenLabsSubtitle: 'Servizio vocale IA cloud',
        providerHappyVoiceSubtitle: 'Gateway vocale self-hosted',
