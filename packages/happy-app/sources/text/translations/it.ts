...
export const it: TranslationStructure = {
    ...
    deviceEnvironmentDashboard: {
        previousResult: 'Risultato del controllo precedente',
        fleetDisconnected: ({ total }: { total: number }) => `${total} dispositivi · connessione interrotta`,
        waitingForConnection: 'In attesa della connessione per il controllo automatico',
        incompleteSummary: ({ count }: { count: number }) => `${count} elementi non verificati. Controlla di nuovo.`,
        noOnline: 'Nessun dispositivo è online',
        confirmStopped: 'Ho verificato che è terminato',
        confirmStoppedMessage: 'Continua solo dopo aver verificato sul dispositivo che il processo di aggiornamento precedente sia terminato. Questa azione non arresta alcun processo remoto e ricontrolla soltanto il dispositivo; non riprova l’aggiornamento.',
        tools: 'Strumenti di sviluppo',
        scan: 'Controlla di nuovo',
        scanning: 'Controllo in corso…',
        fleet: ({ total, online }: { total: number; online: number }) => `${total} dispositivi · ${online} online`,
        lastChecked: ({ time }: { time: string }) => `Controllato: ${time}`,
        notChecked: 'Non ancora controllato',
        offline: 'Offline · risultato precedente',
        online: 'Online',
        latest: 'Aggiornato',
        available: 'Aggiornamento disponibile',
        update: 'Aggiorna',
        updateType: ({ count }: { count: number }) => `Aggiorna strumento · ${count}`,
        updateAll: ({ count }: { count: number }) => `Aggiorna disponibili · ${count}`,
        install: 'Installa',
        login: 'Accedi',
        handle: 'Risolvi',
        retry: 'Riprova',
        queued: 'In coda',
        preparing: 'Controllo dell’aggiornamento',
        updating: 'Aggiornamento e verifica in corso',
        succeeded: 'Aggiornato · verificato',
        failed: 'Aggiornamento non riuscito',
        uncertain: 'Risultato non confermato',
        unresolvedHint: 'Un aggiornamento remoto potrebbe essere ancora in corso. Gli aggiornamenti su questo dispositivo sono sospesi; controllare le versioni non conferma che il processo sia terminato. Verifica il completamento sul dispositivo prima di continuare.',
        changed: 'L’ambiente è cambiato · ricontrolla',
        pendingLogin: 'Installato · accesso richiesto',
        pendingPair: 'Problema di compatibilità tra app e CLI',
        usable: 'Installato',
        sourceUnknown: 'Ultima versione non disponibile',
        ahead: 'Più recente di questa fonte',
        certificateOptional: 'Tunnel temporanei disponibili · accesso facoltativo',
        updatesSummary: ({ count, machines }: { count: number; machines: number }) => `${count} aggiornamenti su ${machines} dispositivi`,
        attentionSummary: ({ count }: { count: number }) => `${count} elementi richiedono una configurazione separata`,
        allCurrent: 'Nessun aggiornamento disponibile sui dispositivi online',
        batchProgress: ({ done, total }: { done: number; total: number }) => `Aggiornamento di ${total} elementi · ${done} completati`,
        batchResult: ({ succeeded, failed, uncertain, skipped }: { succeeded: number; failed: number; uncertain: number; skipped: number }) => `Completati: ${succeeded} · non riusciti: ${failed} · non confermati: ${uncertain} · saltati: ${skipped}`,
        background: 'Puoi chiudere questo pannello e controllare i progressi più tardi.',
        verifyHint: 'Gli aggiornamenti vengono verificati automaticamente; i dispositivi offline vengono saltati.',
        horizontalHint: 'Scorri orizzontalmente per confrontare i dispositivi',
        target: ({ version }: { version: string }) => `Disponibile: ${version}`,
        actionConfirmTitle: 'Continuare su questo dispositivo?',
        actionConfirm: ({ machine, component, action, version }: { machine: string; component: string; action: string; version: string }) => `${machine}: ${action} ${component} (${version}). L’accesso e la configurazione potrebbero aprire una finestra su quel dispositivo.`,
        manualHint: 'Esegui i comandi seguenti sul dispositivo di destinazione, poi controlla di nuovo.',
        selectedAction: ({ machine, component, action }: { machine: string; component: string; action: string }) => `${machine} · ${component} · ${action}`,
        localSource: 'La versione di destinazione proviene dalla fonte di installazione di questo dispositivo.',
    },
    deviceEnvironment: {
        actionEgoUpgrade: ({ from, version }: { from: string; version: string }) => `Aggiorna Ego Lite e CLI ${from} → ${version}`,
        actionEgoOnboard: 'Completa la configurazione iniziale di Ego CLI', actionWranglerInstall: ({ version }: { version: string }) => `Installa Wrangler ${version}`, actionWranglerUpgrade: ({ from, version }: { from: string; version: string }) => `Aggiorna Wrangler ${from} → ${version}`, actionWranglerAuthenticate: 'Accedi a Cloudflare con Wrangler', actionCloudflaredInstall: ({ version }: { version: string }) => `Installa cloudflared ${version}`, actionCloudflaredUpgrade: ({ from, version }: { from: string; version: string }) => `Aggiorna cloudflared ${from} → ${version}`, actionCloudflaredAuthenticate: 'Apri l’accesso al tunnel Cloudflare', confirmToolTitle: ({ component }: { component: string }) => `Allineare ${component}?`, confirmToolMessage: ({ actions }: { actions: string }) => `Verifica l’azione esatta per ogni macchina:\n\n${actions}\n\nInstallazioni e aggiornamenti usano solo il proprietario verificato del pacchetto. Accesso e configurazione iniziale aprono il flusso interattivo ufficiale sulla macchina. Le credenziali non vengono mai copiate tra macchine.`,
        egoPathReady: "Ego CLI è disponibile nel PATH",
        egoPathMissing: "Aggiungi ~/.local/bin al PATH per eseguire ego-browser per nome.",
        egoCliMissing: "Ego CLI non è presente. Completa la configurazione iniziale di Ego Lite su questa macchina.",
        egoAppMissing: "L’app Ego Lite non è presente. Installala e completa la configurazione iniziale su questa macchina.",
        egoUnsupported: "I controlli dell’app Ego Lite richiedono macOS; su questa piattaforma vengono mostrate solo le versioni della CLI.",
        pawsUnsupported: "L’allineamento di Paws CLI richiede un Mac con Apple Silicon e un’installazione npm globale verificata.",
        componentUnsupported: "Il controllo di questo componente non è supportato su questa piattaforma.",
        cloudflaredFormulaUnavailable: "La formula cloudflared non è disponibile. Controlla Homebrew su questa macchina.",
        cloudflaredHomebrewMissing: "Homebrew non è presente; non è possibile controllare l’ultima versione di cloudflared.",
        componentVersionSourceMismatch: "Le fonti delle versioni non coincidono. Controlla l’installazione di questo componente e ripeti la scansione.",
        title: "Ambiente del dispositivo",
        subtitle: "Ispeziona e allinea gli strumenti di sviluppo sulle tue macchine",
        fleetReady: ({ ready, total }: { ready: number; total: number }) => `${ready}/${total} macchine alla versione di destinazione`,
        scanAll: "Scansiona tutte le macchine",
        scanning: "Scansione delle macchine…",
        previewAlignment: "Anteprima dell’allineamento",
        previewing: "Preparazione dell’anteprima…",
        confirmTitle: "Allineare GitHub CLI?",
        confirmMessage: ({ actions }: { actions: string }) => `Controlla l’azione esatta per ogni macchina:\n\n${actions}\n\nVerranno eseguite solo le installazioni e gli aggiornamenti elencati. È necessario accedere su ogni macchina.`,
        confirmAction: "Applica allineamento",
        applying: "Applicazione dell’allineamento…",
        completed: "Completato",
        githubCli: "GitHub CLI",
        daemonOnline: "Daemon connesso",
        daemonOffline: "Daemon disconnesso: ignorato",
        offlineRecovery: "Ripristina la connessione di questa macchina o controllala tramite SSH. Poi ripeti la scansione.",
        versionInstalled: ({ version }: { version: string }) => `Installata: ${version}`,
        versionTarget: ({ version }: { version: string }) => `Destinazione: ${version}`,
        authReady: "GitHub autenticato",
        authMissing: "È necessario accedere a GitHub",
        authUnknown: "Autenticazione GitHub sconosciuta",
        actionNone: "Nessuna modifica di versione",
        actionInstall: ({ version }: { version: string }) => `Installa gh ${version}`,
        actionUpgrade: ({ from, version }: { from: string; version: string }) => `Aggiorna gh ${from} → ${version}`,
        actionManualRepair: "Riparazione manuale necessaria; nessuna modifica automatica",
        repairWithSsh: "Connettiti a questa macchina tramite SSH per completare la configurazione o la riparazione.",
        repairLocally: "Apri un terminale su questa macchina per completare la configurazione o la riparazione.",
        scanAgain: "Ripeti la scansione per aggiornare lo stato della macchina",
        stateUnknown: "Stato sconosciuto; ripeti la scansione",
        timeoutRecovery: "Attendi la fine di Homebrew o dell’operazione corrente, poi ripeti la scansione prima di riprovare.",
        partialFailure: "Alcune macchine richiedono ancora attenzione. Controlla i risultati di seguito.",
        versionSourceMismatch: "Le fonti delle versioni non coincidono. Aggiorna le informazioni di Homebrew sulle macchine interessate e ripeti la scansione.",
        homebrewMissing: "Homebrew non è installato. Installalo su questa macchina prima dell’allineamento.",
        unsupportedMachine: "L’allineamento automatico richiede un Mac con Apple Silicon e Homebrew installato.",
        operationInProgress: "Un’altra operazione è in corso su questa macchina. Attendi e ripeti la scansione.",
        planExpired: "L’anteprima è scaduta o la macchina è cambiata. Ripeti la scansione e l’anteprima.",
        formulaUnavailable: "La formula gh non è disponibile. Controlla Homebrew su questa macchina.",
        versionAhead: "La versione installata è più recente di quella di destinazione. Controllala manualmente; non verrà effettuato un downgrade.",
        alignmentFailed: "L’allineamento non è stato completato. Controlla questa macchina e ripeti la scansione.",
        notInstalled: "Non installato",
        previewRequired: "Apri l’anteprima per vedere l’azione esatta",
        emptyFleet: "Nessuna macchina registrata. Collegane una per iniziare.",
        authenticationNote: "La versione e l’autenticazione GitHub vengono controllate separatamente. Accedi su ogni macchina con gh auth login.",
        confirmPawsMessage: ({ actions }: { actions: string }) => `Rivedi l’azione Paws CLI per ogni macchina:\n\n${actions}\n\nVerranno eseguite solo le installazioni e gli aggiornamenti npm globali elencati. È richiesta la proprietà npm verificata.`, pawsTimeoutRecovery: 'Attendi che npm o l’operazione corrente finisca, quindi esegui di nuovo la scansione.', componentTimeoutRecovery: 'Attendi che l’operazione corrente finisca, quindi esegui di nuovo la scansione.', pawsOwnershipMismatch: 'Non è stato possibile verificare la proprietà di Paws CLI. Controlla il prefisso npm globale prima di allineare.', inspectOnly: 'Solo ispezione',
        developmentEnvironmentHealth: 'Stato dell’ambiente di sviluppo', componentReadyCount: ({ ready, total }: { ready: number; total: number }) => `${ready}/${total} controlli pronti`, componentReady: 'Pronto', componentWarning: 'Richiede attenzione', componentUnknown: 'Sconosciuto', pawsCli: 'Paws CLI', egoBrowser: 'Ego Lite e CLI', cloudflareWrangler: 'Cloudflare Wrangler', cloudflared: 'cloudflared', versionLatest: ({ version }: { version: string }) => `Ultima: ${version}`, pawsOwnershipVerified: 'pacchetto npm globale verificato', pawsOwnershipUnverified: 'Paws CLI non appartiene a questa installazione npm globale', egoAppVersion: ({ version }: { version: string }) => `Ego Lite: ${version}`, egoCliVersion: ({ version }: { version: string }) => `Ego CLI: ${version}`, egoChromiumVersion: ({ version }: { version: string }) => `Chromium: ${version}`, egoNodeVersion: ({ version }: { version: string }) => `Node: ${version}`, egoPaired: 'le versioni di Ego Lite e CLI corrispondono', egoMismatch: 'le versioni di Ego Lite e CLI non corrispondono', cloudflareAuthReady: 'Cloudflare autenticato', cloudflareAuthMissing: 'Accesso a Cloudflare richiesto', cloudflareAuthUnknown: 'Autenticazione Cloudflare sconosciuta', cloudflareAccounts: ({ accounts }: { accounts: string }) => `Account: ${accounts}`, tunnelCertificatePresent: 'Certificato di accesso al tunnel presente', tunnelCertificateMissing: 'Certificato di accesso al tunnel mancante', actionPawsInstall: ({ version }: { version: string }) => `Installa Paws CLI ${version}`, actionPawsUpgrade: ({ from, version }: { from: string; version: string }) => `Aggiorna Paws CLI ${from} → ${version}`, confirmPawsTitle: 'Allineare Paws CLI?', selectAlignmentTool: ({ component }: { component: string }) => `Seleziona allineamento ${component}`, previewComponentAlignment: ({ component }: { component: string }) => `Anteprima allineamento ${component}`, confirmComponentAction: ({ component }: { component: string }) => `Applica allineamento ${component}`,
    },
    relationshipAdvisor: {
    ...
    relationshipAdvisorPlugin: {
        ...
        encryptionNotice: 'La configurazione, inclusa la chiave API, viene crittografata e salvata sul server Paws. Una chiave salvata viene restituita a questa app solo quando scegli esplicitamente di mostrarla.',
        secretRevealFailed: 'Impossibile mostrare la chiave salvata. Riprova.',
        apiKey: 'Chiave API',
    ...
    sessionHistory: {
        ...
        archiveEmptyDescription: 'Le sessioni archiviate appariranno qui.',
        today: 'Oggi',
        yesterday: 'Ieri',
        daysAgo: ({ count }: { count: number }) => `${count} ${count === 1 ? 'giorno' : 'giorni'} fa`,
    ...
    session: {
        ...
        anchorsLoadedSubtitle: ({ count }: { count: number }) => `${count === 1 ? '1 messaggio caricato' : `${count} messaggi caricati`} · Ci sono messaggi precedenti`,
        anchorsLoadOlder: 'Carica messaggi precedenti',
    ...
    sessionShare: {
        ...
        appearance: 'Aspetto della condivisione',
        cover: 'Copertina',
        coverPreview: 'Anteprima della copertina',
        noCover: 'Nessuna copertina',
        randomCover: 'Immagine casuale',
        uploadCover: 'Carica immagine',
        removeCover: 'Rimuovi copertina',
        coverProviderUnavailable: 'Pexels non è disponibile. Puoi comunque caricare un\'immagine o condividere senza copertina.',
        coverUploadFailed: 'Non è stato possibile selezionare l\'immagine. Riprova.',
        themeColor: 'Colore del tema',
        themeColorOption: ({ theme }: { theme: string }) => `Colore del tema: ${theme}`,
        appearanceLight: 'Chiaro',
        appearanceDark: 'Scuro',
        appearanceSystem: 'Sistema',
        coverAttribution: ({ photographer }: { photographer: string }) => `Foto di ${photographer} su Pexels`,
    ...
    updateBanner: {
        otaOnlyTitle: "Nessun aggiornamento OTA",
        otaOnlyMessage: "Non ci sono aggiornamenti OTA per questa installazione. Questo pacchetto non supporta il controllo delle versioni native.",
        tapToDownloadGitHub: "Scarica da GitHub Release",
        nativeUpdateMessage: "È disponibile un nuovo pacchetto dell’app. Alcuni aggiornamenti richiedono il nuovo pacchetto. Scaricalo da GitHub Release e installalo sull’app esistente, senza disinstallarla.",
        downloadApp: "Scarica APK",
        nativeCheckFailedTitle: "Verifica aggiornamento app non disponibile",
        nativeCheckFailedMessage: "Impossibile confermare se esiste una nuova app. Riprova più tardi.",
        ...
        forceCheckSubtitle: "Controlla gli aggiornamenti dell’app e OTA",
