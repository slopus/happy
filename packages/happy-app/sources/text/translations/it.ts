...
export const it: TranslationStructure = {
    ...
    settings: {
        ...
        mcpServersSubtitle: 'Gestisci i server Model Context Protocol',
    ...
    settingsMcp: {
        ...
        activeServersFooter: 'Le modifiche si applicano alle nuove sessioni di Claude Code.',
        disabledServers: 'Server disabilitati',
    ...
    sessionInfo: {
        ...
        renameSessionDescription: 'Imposta un nome personalizzato per questa sessione',
        renameSessionClear: 'Cancella per ripristinare il nome generato automaticamente',
    ...
    claude: {
        ...
        permissions: {
            ...
            yesAllowAll: 'Sì, non chiedere più (consenti tutto)',
