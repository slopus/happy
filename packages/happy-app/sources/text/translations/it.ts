...
export const it: TranslationStructure = {
    ...
    taskManager: {
        selectTask: 'Seleziona un compito per vederne i dettagli',
        machines: 'Macchine',
        noMachines: 'Nessuna macchina collegata',
        agents: 'Agenti',
        ...
        machine: 'Macchina',
        noMachinesOnline: 'Nessuna macchina online. Avvia prima un daemon.',
        agentType: 'Tipo di agente',
        noAgentsOnMachine: 'Nessun agente di codice rilevato su questa macchina.',
        model: 'Modello',
        creating: 'Creazione...',
        saving: 'Salvataggio...',
        ...
        mode: 'Modalità',
        execute: 'Esegui',
        executeHint: "L'agente agisce immediatamente",
        plan: 'Piano',
        planHint: "L'agente propone prima un piano",
        yoloMode: 'YOLO Mode',
        yoloHint: 'Salta tutte le richieste di permessi (--dangerously-skip-permissions)',
        taskPrompt: "Cosa deve fare l'agente?",
        taskPromptPlaceholder: 'Descrivi il compito...',
        createPlan: 'Crea piano',
        createTask: 'Crea compito',
        taskNotFound: 'Compito non trovato',
        agentWorking: 'Agente al lavoro...',
        agentDone: 'Agente ha terminato',
        agentWaiting: 'In attesa',
        agentLabel: 'Agente',
        complete: 'Completato',
        noSession: "Nessuna sessione ancora. In attesa dell'avvio dell'agente...",
        waitingMessages: 'In attesa di messaggi...',
        chatPlaceholder: "Invia un messaggio all'agente... (Cmd+Enter per inviare)",
        send: 'Invia',
        you: 'Tu',
        name: 'Nome',
    },
