...
export const it: TranslationStructure = {
    ...
    settingsVoice: {
        ...
        usageTitle: 'Utilizzo (periodo corrente)',
        usageFooter: 'Utilizzo vocale nel periodo di limite corrente. Piano gratuito: 20 min. Abbonato: 5 ore. Max 100 conversazioni per periodo.',
