...
export const es: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        renameSessionDescription: 'Establecer un nombre personalizado para esta sesión',
        renameSessionClear: 'Borrar para restablecer al nombre generado automáticamente',
        ...
        restartSessionConfirm: '¿Reiniciar esta sesión? Se archivará y se reanudará.',
        archiveAndDelete: '¿Archivar y eliminar esta sesión?',
    ...
    claude: {
        ...
        permissions: {
            ...
            yesAllowAll: 'Sí, no volver a preguntar (permitir todo)',
