...
export const es: TranslationStructure = {
    ...
    settingsVoice: {
        ...
        usageTitle: 'Uso (período actual)',
        usageFooter: 'Uso de voz en el período de límite actual. Plan gratuito: 20 min. Suscrito: 5 horas. Máx. 100 conversaciones por período.',
