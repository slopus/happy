...
export const es: TranslationStructure = {
    ...
    relationshipAdvisorPlugin: {
        ...
        encryptionNotice: 'La configuración, incluida la clave de API, se cifra y se guarda en el servidor de Paws. Después de guardarla, la clave no se devuelve a la aplicación.',
        apiKey: 'Clave de API',
