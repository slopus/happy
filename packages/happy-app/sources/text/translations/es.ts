...
export const es: TranslationStructure = {
    ...
    taskManager: {
        selectTask: 'Selecciona una tarea para ver los detalles',
        machines: 'Máquinas',
        noMachines: 'No hay máquinas conectadas',
        agents: 'Agentes',
        ...
        newTask: 'Nueva tarea',
        machine: 'Máquina',
        noMachinesOnline: 'No hay máquinas en línea. Inicia un daemon primero.',
        agentType: 'Tipo de agente',
        noAgentsOnMachine: 'No se detectaron agentes de código en esta máquina.',
        model: 'Modelo',
        creating: 'Creando...',
        saving: 'Guardando...',
        ...
        mode: 'Modo',
        execute: 'Ejecutar',
        executeHint: 'El agente actúa de inmediato',
        plan: 'Plan',
        planHint: 'El agente propone un plan primero',
        yoloMode: 'YOLO Mode',
        yoloHint: 'Omitir todas las solicitudes de permisos (--dangerously-skip-permissions)',
        taskPrompt: '¿Qué debe hacer el agente?',
        taskPromptPlaceholder: 'Describe la tarea...',
        createPlan: 'Crear plan',
        createTask: 'Crear tarea',
        taskNotFound: 'Tarea no encontrada',
        agentWorking: 'Agente trabajando...',
        agentDone: 'Agente terminó',
        agentWaiting: 'Esperando',
        agentLabel: 'Agente',
        complete: 'Completado',
        noSession: 'Aún no hay sesión. Esperando a que el agente inicie...',
        waitingMessages: 'Esperando mensajes...',
        chatPlaceholder: 'Envía un mensaje al agente... (Cmd+Enter para enviar)',
        send: 'Enviar',
        you: 'Tú',
        name: 'Nombre',
    },
