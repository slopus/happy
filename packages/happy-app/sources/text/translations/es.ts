...
export const es: TranslationStructure = {
    ...
    deviceEnvironmentDashboard: {
        ...
        fleetDisconnected: ({ total }: { total: number }) => `${total} dispositivos · conexión perdida`,
        waitingForConnection: 'Esperando la conexión para comprobar automáticamente',
        incompleteSummary: ({ count }: { count: number }) => `${count} elementos sin verificar. Vuelve a comprobar.`,
        noOnline: 'No hay dispositivos en línea',
        confirmStopped: 'He verificado que ha terminado',
        confirmStoppedMessage: 'Continúa solo después de comprobar en el dispositivo que el proceso de actualización anterior ha terminado. Esta acción no detiene ningún proceso remoto y solo volverá a comprobar el dispositivo; no reintentará la actualización.',
        tools: 'Herramientas de desarrollo',
        scan: 'Volver a comprobar',
        scanning: 'Comprobando…',
        fleet: ({ total, online }: { total: number; online: number }) => `${total} dispositivos · ${online} en línea`,
        lastChecked: ({ time }: { time: string }) => `Comprobado: ${time}`,
        notChecked: 'Sin comprobar',
        offline: 'Sin conexión · resultado anterior',
        online: 'En línea',
        latest: 'Actualizado',
        available: 'Actualización disponible',
        update: 'Actualizar',
        updateType: ({ count }: { count: number }) => `Actualizar herramienta · ${count}`,
        updateAll: ({ count }: { count: number }) => `Actualizar disponibles · ${count}`,
        install: 'Instalar',
        login: 'Iniciar sesión',
        handle: 'Resolver',
        retry: 'Reintentar',
        queued: 'En cola',
        preparing: 'Comprobando actualización',
        updating: 'Actualizando y verificando',
        succeeded: 'Actualizado · verificado',
        failed: 'Error al actualizar',
        uncertain: 'Resultado sin confirmar',
        unresolvedHint: 'Puede que una actualización remota siga en curso. Las actualizaciones en este dispositivo están pausadas; comprobar las versiones no confirma que el proceso haya terminado. Verifica que haya finalizado en el dispositivo antes de continuar.',
        changed: 'El entorno ha cambiado · revísalo de nuevo',
        pendingLogin: 'Instalado · requiere iniciar sesión',
        pendingPair: 'Hay un problema de compatibilidad entre la app y la CLI',
        usable: 'Instalado',
        sourceUnknown: 'No se puede obtener la última versión',
        ahead: 'Más reciente que esta fuente',
        certificateOptional: 'Túneles temporales disponibles · inicio de sesión opcional',
        updatesSummary: ({ count, machines }: { count: number; machines: number }) => `${count} actualizaciones en ${machines} dispositivos`,
        attentionSummary: ({ count }: { count: number }) => `${count} elementos requieren configuración individual`,
        allCurrent: 'No hay actualizaciones disponibles en los dispositivos en línea',
        batchProgress: ({ done, total }: { done: number; total: number }) => `Actualizando ${total} elementos · ${done} completados`,
        batchResult: ({ succeeded, failed, uncertain, skipped }: { succeeded: number; failed: number; uncertain: number; skipped: number }) => `Completados: ${succeeded} · fallidos: ${failed} · sin confirmar: ${uncertain} · omitidos: ${skipped}`,
        background: 'Puedes cerrar este panel y consultar el progreso más tarde.',
        verifyHint: 'Las actualizaciones se verifican automáticamente; se omiten los dispositivos sin conexión.',
        horizontalHint: 'Desliza horizontalmente para comparar dispositivos',
        target: ({ version }: { version: string }) => `Disponible: ${version}`,
        actionConfirmTitle: '¿Continuar en este dispositivo?',
        actionConfirm: ({ machine, component, action, version }: { machine: string; component: string; action: string; version: string }) => `${machine}: ${action} ${component} (${version}). El inicio de sesión y la configuración pueden abrir una ventana en ese dispositivo.`,
        manualHint: 'Ejecuta los siguientes comandos en el dispositivo de destino y vuelve a comprobar.',
        selectedAction: ({ machine, component, action }: { machine: string; component: string; action: string }) => `${machine} · ${component} · ${action}`,
        localSource: 'La versión de destino procede de la fuente de instalación de este dispositivo.',
    },
    deviceEnvironment: {
        ...
        egoAppMissing: "Falta la aplicación Ego Lite. Instálala y completa su configuración inicial en esta máquina.",
        egoUnsupported: "La comprobación de la aplicación Ego Lite requiere macOS; en esta plataforma solo se muestran las versiones de la CLI.",
        pawsUnsupported: "La alineación de Paws CLI requiere un Mac con Apple Silicon y una instalación global de npm verificada.",
        componentUnsupported: "La comprobación de este componente no es compatible con esta plataforma.",
        cloudflaredFormulaUnavailable: "La fórmula cloudflared no está disponible. Revisa Homebrew en esta máquina.",
        cloudflaredHomebrewMissing: "Falta Homebrew; no se puede comprobar la última versión de cloudflared.",
        componentVersionSourceMismatch: "Las fuentes de versión no coinciden. Revisa la instalación de este componente y vuelve a escanear.",
        title: "Entorno del dispositivo",
        subtitle: "Inspecciona y alinea las herramientas de desarrollo de tus máquinas",
        fleetReady: ({ ready, total }: { ready: number; total: number }) => `${ready}/${total} máquinas en la versión objetivo`,
        scanAll: "Escanear todas las máquinas",
        scanning: "Escaneando máquinas…",
        previewAlignment: "Previsualizar alineación",
        previewing: "Preparando vista previa…",
        confirmTitle: "¿Alinear GitHub CLI?",
        confirmMessage: ({ actions }: { actions: string }) => `Revisa la acción exacta para cada máquina:\n\n${actions}\n\nSolo se ejecutarán las instalaciones y actualizaciones indicadas. Debes iniciar sesión en cada máquina.`,
        confirmAction: "Aplicar alineación",
        applying: "Aplicando alineación…",
        completed: "Completado",
        githubCli: "GitHub CLI",
        daemonOnline: "Daemon conectado",
        daemonOffline: "Daemon desconectado: omitido",
        offlineRecovery: "Restablece la conexión de esta máquina o revísala por SSH. Después, vuelve a escanear.",
        versionInstalled: ({ version }: { version: string }) => `Instalada: ${version}`,
        versionTarget: ({ version }: { version: string }) => `Objetivo: ${version}`,
        authReady: "GitHub autenticado",
        authMissing: "Debes iniciar sesión en GitHub",
        authUnknown: "Autenticación de GitHub desconocida",
        actionNone: "Sin cambios de versión",
        actionInstall: ({ version }: { version: string }) => `Instalar gh ${version}`,
        actionUpgrade: ({ from, version }: { from: string; version: string }) => `Actualizar gh ${from} → ${version}`,
        actionManualRepair: "Reparación manual necesaria; no se realizarán cambios automáticos",
        repairWithSsh: "Conéctate a esta máquina por SSH para completar la configuración o reparación.",
        repairLocally: "Abre una terminal en esta máquina para completar la configuración o reparación.",
        scanAgain: "Vuelve a escanear para actualizar el estado de la máquina",
        stateUnknown: "Estado desconocido; vuelve a escanear",
        timeoutRecovery: "Espera a que termine Homebrew o la operación actual y vuelve a escanear antes de reintentar.",
        partialFailure: "Algunas máquinas aún requieren atención. Revisa sus resultados a continuación.",
        versionSourceMismatch: "Las fuentes de versión no coinciden. Actualiza la información de Homebrew en las máquinas afectadas y vuelve a escanear.",
        homebrewMissing: "Falta Homebrew. Instálalo en esta máquina antes de alinear.",
        unsupportedMachine: "La alineación automática requiere un Mac con Apple Silicon y Homebrew instalado.",
        operationInProgress: "Hay otra operación en curso en esta máquina. Espera y vuelve a escanear.",
        planExpired: "La vista previa ha caducado o la máquina ha cambiado. Escanea y previsualiza de nuevo.",
        formulaUnavailable: "La fórmula gh no está disponible. Revisa Homebrew en esta máquina.",
        versionAhead: "La versión instalada es posterior a la objetivo. Revísala manualmente; no se instalará una versión anterior.",
        alignmentFailed: "La alineación no se completó. Revisa esta máquina y vuelve a escanear.",
        notInstalled: "No instalado",
        previewRequired: "Previsualiza para ver la acción exacta",
        emptyFleet: "Aún no hay máquinas registradas. Conecta una para empezar.",
        authenticationNote: "La versión y la autenticación de GitHub se comprueban por separado. Inicia sesión en cada máquina con gh auth login.",
        developmentEnvironmentHealth: 'Estado del entorno de desarrollo', componentReadyCount: ({ ready, total }: { ready: number; total: number }) => `${ready}/${total} comprobaciones listas`, componentReady: 'Listo', componentWarning: 'Requiere atención', componentUnknown: 'Desconocido', pawsCli: 'Paws CLI', egoBrowser: 'Ego Lite y CLI', cloudflareWrangler: 'Cloudflare Wrangler', cloudflared: 'cloudflared', versionLatest: ({ version }: { version: string }) => `Última: ${version}`, pawsOwnershipVerified: 'paquete global de npm verificado', pawsOwnershipUnverified: 'Paws CLI no pertenece a esta instalación global de npm', egoAppVersion: ({ version }: { version: string }) => `Ego Lite: ${version}`, egoCliVersion: ({ version }: { version: string }) => `Ego CLI: ${version}`, egoChromiumVersion: ({ version }: { version: string }) => `Chromium: ${version}`, egoNodeVersion: ({ version }: { version: string }) => `Node: ${version}`, egoPaired: 'las versiones de Ego Lite y CLI coinciden', egoMismatch: 'las versiones de Ego Lite y CLI no coinciden', cloudflareAuthReady: 'Cloudflare autenticado', cloudflareAuthMissing: 'Se requiere iniciar sesión en Cloudflare', cloudflareAuthUnknown: 'Autenticación de Cloudflare desconocida', cloudflareAccounts: ({ accounts }: { accounts: string }) => `Cuentas: ${accounts}`, tunnelCertificatePresent: 'Certificado de inicio de sesión del túnel presente', tunnelCertificateMissing: 'Falta el certificado de inicio de sesión del túnel', actionPawsInstall: ({ version }: { version: string }) => `Instalar Paws CLI ${version}`, actionPawsUpgrade: ({ from, version }: { from: string; version: string }) => `Actualizar Paws CLI ${from} → ${version}`, confirmPawsTitle: '¿Alinear Paws CLI?', selectAlignmentTool: ({ component }: { component: string }) => `Seleccionar alineación de ${component}`, previewComponentAlignment: ({ component }: { component: string }) => `Previsualizar alineación de ${component}`, confirmComponentAction: ({ component }: { component: string }) => `Aplicar alineación de ${component}`,
        confirmPawsMessage: ({ actions }: { actions: string }) => `Revise la acción de Paws CLI en cada máquina:\n\n${actions}\n\nSolo se ejecutarán las instalaciones y actualizaciones globales de npm indicadas. Se requiere propiedad de npm verificada.`, pawsTimeoutRecovery: 'Espere a que finalice npm o la operación actual y vuelva a escanear.', componentTimeoutRecovery: 'Espere a que finalice la operación actual y vuelva a escanear.', pawsOwnershipMismatch: 'No se pudo verificar la propiedad de Paws CLI. Revise el prefijo global de npm antes de alinear.', inspectOnly: 'Solo inspección',
    },
    relationshipAdvisor: {
        ...
        deleteConversationAccessibility: 'Eliminar conversación',
        deleteConfirmTitle: '¿Eliminar esta conversación?',
        deleteConfirmMessage: 'Los mensajes guardados de esta conversación con el consejero sentimental se eliminarán de este dispositivo.',
        clear: 'Borrar',
    ...
    relationshipAdvisorPlugin: {
        marketTitle: 'Complementos',
        marketSubtitle: 'Descubre y habilita los complementos incluidos con esta versión de Paws.',
        searchPlaceholder: 'Buscar complementos',
        installedSection: 'Instalados',
        featuredSection: 'Destacados',
        emptySearch: 'No se encontraron complementos',
        openPlugin: 'Abrir complemento',
        configure: 'Configurar',
        configuration: 'Configuración del complemento',
        permissions: 'Permisos',
        permissionGrantNotice: 'Al instalar o actualizar, se conceden estos permisos a esta cuenta. Al desinstalar, se revocan.',
        builtInCode: 'Código integrado de confianza',
        builtInCodeNotice: 'El código del complemento se incluye con esta versión de Paws. La instalación solo lo habilita para tu cuenta.',
        permissionAiProviderInvoke: 'Usar un proveedor de IA',
        permissionAiProviderInvokeDescription: 'Envía las solicitudes de conversación de este complemento al proveedor de IA configurado.',
        permissionSecretsUse: 'Usar secretos cifrados',
        permissionSecretsUseDescription: 'Lee la configuración cifrada de este complemento solo mientras se ejecuta.',
        permissionConversationImagesRead: 'Leer imágenes de la conversación',
        permissionConversationImagesReadDescription: 'Lee los archivos de imagen adjuntos que decidas enviar a este complemento.',
        permissionStorageImagesWrite: 'Guardar imágenes del complemento',
        permissionStorageImagesWriteDescription: 'Sube y elimina imágenes creadas o utilizadas por este complemento.',
        encryptionNotice: 'La configuración, incluida la clave de API, se cifra y se guarda en el servidor de Paws. Una clave guardada solo se devuelve a esta aplicación cuando eliges explícitamente mostrarla.',
        secretRevealFailed: 'No se ha podido mostrar la clave guardada. Inténtalo de nuevo.',
        apiKey: 'Clave de API',
        apiKeyConfigured: ({ hint }: { hint: string }) => `Configurada · termina en ${hint}`,
        apiKeyPlaceholder: 'Por ejemplo: sk-...',
        baseUrl: 'URL base',
        baseUrlPlaceholder: 'Por ejemplo: https://api.deepseek.com',
        model: 'Modelo',
        modelPlaceholder: 'Por ejemplo: deepseek-v4-flash-vision-exp',
        unsavedChangesTitle: 'Cambios sin guardar',
        unsavedChangesSubtitle: 'La configuración actual aún no se ha guardado. Guárdala antes de salir',
        modelRecommendation: 'Elige preferentemente un modelo compatible con multimodalidad para comprender texto e imágenes',
        testConnection: 'Probar conexión',
        testConnectionSubtitle: 'Tras una prueba correcta, la configuración actual se guarda automáticamente',
        connectionSuccess: 'Conexión correcta',
        connectionSuccessSubtitle: 'La configuración actual permite conectar con el proveedor y el modelo',
        connectionAuthenticationFailed: 'Error de autenticación',
        connectionModelNotFound: 'Modelo no encontrado',
        connectionRateLimited: 'Se alcanzó el límite de solicitudes',
        connectionTimedOut: 'Se agotó el tiempo de conexión',
        connectionUnreachable: 'No se pudo contactar con el proveedor',
        connectionProviderError: 'El proveedor devolvió un error',
        status: 'Estado del complemento',
        installed: 'Instalado',
        installedSubtitle: 'Listo para usar en esta cuenta',
        reviewRequired: 'Revisión necesaria',
        reviewRequiredSubtitle: 'La versión o los permisos cambiaron. Revisa y actualiza antes de usarlo.',
        reviewAndUpdate: 'Revisar y actualizar',
        notInstalled: 'No instalado',
        notInstalledSubtitle: 'Completa la configuración e instala el complemento',
        update: 'Actualizar configuración',
        install: 'Instalar complemento',
        installSubtitle: 'Cifra la configuración y guárdala en el servidor de Paws',
        uninstall: 'Desinstalar complemento',
        uninstallSubtitle: 'Elimina el complemento y las credenciales guardadas',
    },
    healthPanel: {
    ...
    generatedImageBatchDownload: {
        ...
        generating: ({ completed, total }: { completed: number; total: number }) => `Generando ${completed}/${total}`,
        downloadAll: ({ count }: { count: number }) => `Descargar todas (${count})`,
        downloading: ({ completed, total }: { completed: number; total: number }) => `Descargando ${completed}/${total}`,
        saved: ({ count }: { count: number }) => `${count} imágenes guardadas`,
        savedBrowser: ({ count }: { count: number }) => `${count} descargas iniciadas · Permite varias descargas si el navegador lo solicita`,
        savedDirectory: ({ count }: { count: number }) => `${count} imágenes guardadas en la carpeta seleccionada`,
        savedPhotos: ({ count }: { count: number }) => `${count} imágenes guardadas en Fotos`,
        cancelledBrowser: 'Descargas canceladas · Vuelve a intentarlo y permite varias descargas',
        cancelledDirectory: 'No se seleccionó una carpeta · Elige dónde guardar las imágenes',
        cancelledPhotos: 'Se necesita acceso a Fotos para guardar las imágenes generadas',
        cancelledUnsupported: 'La descarga por lotes no está disponible en esta plataforma',
        partial: ({ succeeded, failed }: { succeeded: number; failed: number }) => `${succeeded} guardadas · ${failed} con error`,
        retryFailed: ({ count }: { count: number }) => `Reintentar fallidas (${count})`,
    },
    desktopWorkspace: {
        sessions: 'Sesiones',
        showSessions: 'Mostrar la barra lateral de sesiones',
        hideSessions: 'Ocultar la barra lateral de sesiones',
    ...
    keyboardShortcuts: {
        ...
        close: 'Cerrar los atajos de teclado',
        open: 'Abrir los atajos de teclado',
        common: 'General',
        navigation: 'Navegación',
        commandPalette: 'Paleta de comandos',
        conversation: 'Conversación y entrada de texto',
        desktopApp: 'Aplicación de escritorio',
        openCommandPalette: 'Abrir la paleta de comandos',
        openSettings: 'Abrir la configuración de la aplicación',
        toggleLeftSidebar: 'Mostrar u ocultar la barra lateral de sesiones',
        toggleRightPanel: 'Mostrar u ocultar el panel de detalles',
        closeOrGoBack: 'Cerrar la capa superior o volver atrás',
        closeOrGoBackDetail: 'Cierra la ventana modal o la superposición, o sale del modo zen; si no hay nada que cerrar, retrocede en el historial de navegación',
        moveSelection: 'Mover la selección',
        runSelected: 'Ejecutar el comando seleccionado',
        closeCommandPalette: 'Cerrar la paleta de comandos',
        runNumberedResult: 'Ejecutar el resultado visible numerado del 1 al 9',
        sendMessage: 'Enviar mensaje',
        insertNewLine: 'Insertar una línea nueva',
        navigateSuggestions: 'Recorrer las sugerencias',
        acceptSuggestion: 'Aceptar la sugerencia',
        closeSuggestions: 'Cerrar las sugerencias',
        stopRunningAgent: 'Detener el agente en ejecución',
        pressTwice: 'Presiona dos veces en un plazo de dos segundos',
    ...
    generatedImages: {
        ...
        pluginInstalledSubtitle: 'La galería de imágenes generadas está disponible en esta cuenta.',
        pluginNotInstalledSubtitle: 'Instala el complemento para explorar las imágenes generadas.',
        pluginInstallSubtitle: 'Activa la galería de imágenes generadas para esta cuenta.',
        pluginUninstallSubtitle: 'Desactiva el acceso a la galería sin eliminar las imágenes generadas.',
        pluginPrivacyNotice: 'No se necesita una clave de API. Paws solo guarda en el servidor un marcador de instalación cifrado.',
    ...
    rightPanelCapabilityHub: {
        ...
        empty: {
            outputs: 'Los archivos, las vistas previas y otros resultados de la tarea aparecerán aquí.',
            sources: 'Los enlaces web y los archivos adjuntos utilizados en esta tarea aparecerán aquí.',
    ...
    newSession: {
        submissionRestoreTextOnly: "Restaurar solo texto",
        submissionOmitAttachmentsWarning: "Se omitirán los adjuntos originales. La sesión o el mensaje podrían existir ya. Revisa la sesión antes de volver a enviar.",
        submissionRestored: "El texto restaurado se guarda aquí hasta que el siguiente envío se guarde de forma segura.",
    ...
    sessionInfo: {
        ...
        agentPanelRuntimeLocation: 'Ubicación de ejecución',
        agentPanelCurrentExecution: 'Esta ejecución',
        agentPanelSessionManagement: 'Gestión de la sesión',
        agentPanelMachineStatus: 'Estado de la máquina',
        agentPanelAddress: 'Dirección',
        agentPanelWorkingDirectory: 'Directorio de trabajo',
        agentPanelAgent: 'Agente',
        agentPanelModel: 'Modelo',
        agentPanelEffort: 'Esfuerzo de razonamiento',
        agentPanelPermissions: 'Permisos',
        agentPanelOfflineNotice: 'Esta máquina está sin conexión. Se conserva la configuración, pero la ejecución no está disponible.',
        agentPanelReadOnly: 'Solo lectura',
        ...
        failedToRestoreSession: 'No se pudo restaurar la sesión',
        sessionRowRemoteLocation: ({ name }: { name: string }) => `Remoto · ${name}`,
        sessionRowUnknownLocation: 'Ubicación desconocida/local',
        sessionRowUnknownAgent: 'Agente desconocido',
        sessionRowProjectPath: 'Proyecto/ruta',
        sessionRowMachineAgent: 'Equipo/agente',
        sessionRowRelativeTime: 'Tiempo relativo',
        sessionRowRunningStatus: 'Estado de ejecución',
        sessionRowMoreActions: 'Más acciones de sesión',
    ...
    sessionShare: {
        ...
        appearance: 'Apariencia del enlace',
        cover: 'Portada',
        coverPreview: 'Vista previa de la portada',
        noCover: 'Sin portada',
        randomCover: 'Imagen aleatoria',
        uploadCover: 'Subir imagen',
        removeCover: 'Quitar portada',
        coverProviderUnavailable: 'Pexels no está disponible. Aún puedes subir una imagen o compartir sin portada.',
        coverUploadFailed: 'No se pudo seleccionar la imagen. Inténtalo de nuevo.',
        themeColor: 'Color del tema',
        themeColorOption: ({ theme }: { theme: string }) => `Color del tema: ${theme}`,
        appearanceLight: 'Claro',
        appearanceDark: 'Oscuro',
        appearanceSystem: 'Sistema',
        coverAttribution: ({ photographer }: { photographer: string }) => `Foto de ${photographer} en Pexels`,
    ...
    components: {
        ...
        messageComposer: {
            ...
            workingDirectoryBrowse: 'Explorar carpetas',
            workingDirectoryRecent: 'Directorios recientes',
            workingDirectoryNoRecent: 'No hay otros directorios recientes en esta máquina',
            workingDirectorySelectCurrent: ({ name }: { name: string }) => `Usar ${name}`,
            workingDirectoryError: ({ reason }: { reason: string }) => `No se puede usar este directorio. Comprueba la ruta y el acceso e inténtalo de nuevo. ${reason}`,
            workingDirectoryEmpty: 'Introduce o selecciona primero un directorio.',
            workingDirectoryOffline: 'La máquina del Agent está desconectada. Vuelve a conectarla antes de cambiar el directorio.',
    ...
    agentInput: {
        ...
        taskPermission: {
            ...
            confirmShort: 'Preguntar',
            confirmDescription: 'Usa el flujo de confirmación del agente para las acciones que necesitan permisos adicionales. Los límites del dispositivo y del entorno aislado externo siguen vigentes.',
            fullAccess: 'Acceso completo',
            fullAccessShort: 'Completo',
            fullAccessDescription: 'Omite las confirmaciones del agente cuando es compatible. Los límites del dispositivo y del entorno aislado externo siguen vigentes.',
            changesNextMessages: 'Se aplica al siguiente mensaje y a los posteriores.',
            unsupported: 'Este agente no ofrece dos niveles de permisos fiables.',
            unavailable: 'No disponible',
            riskTitle: '¿Activar el acceso completo?',
            riskMessage: 'El acceso completo omite las confirmaciones del agente cuando es compatible, incluso para acciones potencialmente peligrosas. No anula los límites del dispositivo ni del entorno aislado externo. Continúa solo si confías en esta tarea.',
            riskConfirm: 'Activar acceso completo',
        },
        agent: {
            claude: 'Claude',
            codex: 'Codex',
    ...
    sidebarLists: {
        lists: 'Lists', tags: 'Tags', newList: 'New list', newTag: 'New tag', tagNamePlaceholder: 'Tag name', noTaggedSessions: 'No sessions use this tag yet.', noTags: 'No tags yet', agentList: 'Agent list', workspaceList: 'Workspace list', newSessionInList: 'New session in this list', emptyList: 'No sessions in this list yet.', unassigned: 'Unassigned', unassignedDescription: 'Sessions not in a list', organizeSession: 'Organize session', listName: 'List name', listNamePlaceholder: 'For example: Happy', duplicateListName: 'A list with this name already exists.', listType: 'List type', color: 'Color', defaultMachine: 'Default machine', defaultDirectory: 'Default directory', directoryPlaceholder: '~/projects/happy', defaultAgent: 'Default Agent', noPreset: 'No preset', agentPrompt: 'Agent prompt', agentPromptPlaceholder: 'Prompt applied when starting from this Agent list', belongsToList: 'List', tagsMultiSelect: 'Tags (select multiple)', selectedTags: 'Etiquetas seleccionadas', tagInputPlaceholder: 'Escribe # para buscar o crear una etiqueta', createTagNamed: ({ name }: { name: string }) => `Crear ${name}`, tagLimitReached: 'Se alcanzó el límite de etiquetas', close: 'Close', editList: 'Editar lista', deleteList: 'Eliminar lista', deleteListConfirm: ({ name }: { name: string }) => `Al eliminar la lista «${name}», sus sesiones volverán a Sin asignar. Las etiquetas no se verán afectadas.`, tagActions: 'Tag actions', groupedByList: 'Grouped by list', tagDetailsMeta: ({ sessionCount, listCount }: { sessionCount: number; listCount: number }) => `${sessionCount} sessions · ${listCount} lists`, archived: 'Archivadas', showArchived: 'Mostrar archivadas', hideArchived: 'Ocultar archivadas', archivedSessionsHidden: 'Las sesiones archivadas están ocultas.', tagSessionsNotLoaded: 'Las sesiones históricas vinculadas aún no se han cargado.', tagSessionsPartiallyLoaded: ({ loadedCount, sessionCount }: { loadedCount: number; sessionCount: number }) => `Se muestran ${loadedCount} de ${sessionCount} sesiones vinculadas.`, deleteTag: 'Delete tag', deleteTagConfirm: ({ name }: { name: string }) => `Deleting the tag "${name}" removes it from every session, but does not delete any sessions.`, colors: { blue: 'Blue', green: 'Green', purple: 'Purple', orange: 'Orange', pink: 'Pink' },
    },
    sessionSearch: {
    ...
    mcpApps: {
        ...
        offline: 'Esta App no está disponible mientras la sesión está sin conexión.',
        retry: 'Reintentar',
        unsupported: 'Este dispositivo no admite MCP Apps.',
        unavailable: 'Esta App no está disponible.',
        openLinkTitle: '¿Abrir enlace externo?',
        openLinkMessage: 'Esta App quiere abrir un enlace fuera de Paws.',
        openLinkConfirm: 'Abrir enlace',
    ...
    updateBanner: {
        otaOnlyTitle: "No hay actualizaciones OTA",
        otaOnlyMessage: "No hay actualizaciones OTA para esta instalación. Este paquete no admite la comprobación de versiones nativas.",
        tapToDownloadGitHub: "Descargar desde GitHub Release",
        nativeUpdateMessage: "Hay una nueva versión de la aplicación. Algunas actualizaciones requieren el nuevo paquete. Descárgalo desde GitHub Release e instálalo sobre la aplicación existente, sin desinstalarla.",
        downloadApp: "Descargar APK",
        nativeCheckFailedTitle: "No se pudo comprobar la aplicación",
        nativeCheckFailedMessage: "No se pudo confirmar si hay una nueva aplicación. Inténtalo más tarde.",
        ...
        forceCheckSubtitle: "Comprobar actualizaciones de la aplicación y OTA",
    ...
    modals: {
        ...
        accountLinkRequestNotFound: ({ server }: { server: string }) => `No se encontró la solicitud en ${server}. Confirma que ambos dispositivos usan el mismo servidor, vuelve a abrir el código QR e inténtalo de nuevo.`,
        accountLinkUnauthorized: ({ server }: { server: string }) => `Tu sesión en ${server} ha caducado. Inicia sesión de nuevo y vuelve a intentarlo.`,
        accountLinkNetworkError: ({ server }: { server: string }) => `No se pudo conectar con ${server}. Comprueba la red y la dirección del servidor.`,
        accountLinkServerError: ({ server, status }: { server: string; status: number }) => `${server} rechazó la solicitud (HTTP ${status || 'unknown'}). Vuelve a abrir el código QR e inténtalo de nuevo.`,
    ...
    machine: {
        ...
        codexUsageResetsAt: ({ time }: { time: string }) => `Se restablece ${time}`,
        codexUsageRateLimitWindow: ({ period, used, remaining, resetAt }: { period: string; used: number; remaining: number; resetAt: string }) => `${period}: ${used}% usado · ${remaining}% restante · Restablece ${resetAt}`,
        ...
        codexUsageHeatmap: 'Actividad durante el último año',
        codexUsageHeatmapLegend: 'Menos → Más',
        codexUsageHeatmapDay: ({ date, tokens, sessions }: { date: string; tokens: string; sessions: number }) => `${date}: ${tokens} tokens · ${sessions} sesiones`,
    ...
    markdown: {
        ...
        mermaidOpenFullscreen: 'Abrir el diagrama en pantalla completa',
        mermaidCloseFullscreen: 'Cerrar el diagrama en pantalla completa',
    },
    ...
    imageUpload: {
        ...
        documentOpenFailed: 'No se pudo abrir este PDF.',
        mediaVideo: 'Vídeo',
        mediaAudio: 'Audio',
        mediaPlay: ({ name }: { name: string }) => `Reproducir «${name}»`,
        mediaCollapse: ({ name }: { name: string }) => `Contraer el reproductor de «${name}»`,
        mediaFullscreen: ({ name }: { name: string }) => `Reproducir «${name}» a pantalla completa`,
        mediaLoadFailed: 'No se pudo cargar el archivo multimedia.',
    ...
    imageViewer: {
        ...
        downloadOriginalMotionPhoto: 'Descargar la foto con movimiento original',
        playMotionPhoto: 'Reproducir foto con movimiento',
        stopMotionPhoto: 'Detener foto con movimiento',
        ...
        motionPhotoDownloadFailedMessage: 'No se pudo descargar la foto con movimiento original.',
        motionPhotoLoadFailedMessage: 'No se pudo reproducir esta foto con movimiento.',
    },
    ...
    agents: {
        ...
        folderCustomPath: 'Usando la carpeta personalizada de arriba',
        folderRecent: 'Carpetas recientes',
        folderNoRecent: 'Aún no hay carpetas recientes',
        presets: 'Preajustes',
        ...
        imageStyleHealingScribbleSketchHint: 'Convierte un retrato en un boceto constructivo de anime crudo y sereno, con densas líneas exploratorias de grafito, un rostro tranquilo y simplificado, poco color pálido y mucho papel blanco cálido.\nConserva la identidad mediante la forma del rostro, el pelo, las gafas, la expresión, la pose y una prenda u objeto clave; siempre sin texto.',
        ...
        imageStylePhotoIllustrationEditorialEchoHint: 'Convierte una foto en un póster editorial vertical u horizontal adaptado a la escena, con la fotografía fiel como anclaje, un único eco aislado de acuarela y tinta, y un título, una etiqueta de estudio y un pie breve específicos de la escena, compuestos como texto real y nítido.',
        ...
        imageStyleSceneDistillationZineHint: 'Destila una foto en una ilustración Zine original sobre papel, vertical 3:5 u horizontal 5:3; conserva los anclajes semánticos y emocionales, sin píxeles de la foto original.\nBordes rasgados expresivos, tipografía de autor y un acento vivo intencional; el activador exacto 单色块模式 crea un único campo continuo de color saturado.',
        imageStyleGradeImages: 'Etalonaje fotográfico determinista',
        imageStyleGradeImagesHint: 'Corrige, iguala o aplica color creativo a fotos JPEG/PNG sin edición generativa.\nConserva estrictamente geometría, identidad, rostros, objetos, texto y textura; admite intensidad conservadora a transformadora, recetas reproducibles, vistas previas y controles de calidad.',
        imageStyleScenesGatheredZine: 'Zine de escenas reunidas',
        imageStyleScenesGatheredZineHint: 'Ancla una fotografía fiel en un póster táctil 3:5 espacioso y expande formas de la fuente en un campo ilustrado muy simplificado.\nUn color vivo estructural, unión de papel rasgado con fibras visibles, espacio negativo activo y microtexto discreto.',
        imageStyleScenesGatheredZineSea: 'Zine de escenas reunidas · Mar',
        imageStyleScenesGatheredZineSeaHint: 'Referencia costera del mismo compilador: fotografía fiel de mar/barandilla, papel amplio y tranquilo, bordes rasgados fibrosos, marcas impresas comprimidas, un color estructural y microtexto discreto.',
