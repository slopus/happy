...
export const es: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        worktree: {
            ...
            createPRConfirm: ({ branch }: { branch: string }) => `¿Crear un Pull Request para la rama "${branch}"?`,
            ...
            mergeBranchSubtitle: 'Fusionar la rama del worktree con la rama base',
            mergeConfirm: ({ branch }: { branch: string }) => `¿Fusionar "${branch}" con la rama base?`,
            ...
            cleanupSubtitle: 'Eliminar el directorio del worktree (la rama se conserva)',
            cleanupConfirm: '¿Eliminar el worktree? La rama se conservará por seguridad.',
            ...
            archiveAndCleanup: 'Archivar y limpiar',
            ...
            reviewDiffFailed: 'Error al obtener el diff del PR',
