...
export const pt: TranslationStructure = {
    ...
    newSession: {
        ...
        useCustomPath: ({ path }: { path: string }) => `Usar ${path}`,
        noResults: 'Sem resultados',
        searchMachines: 'Pesquisar máquinas...',
        searchOrEnterPath: 'Pesquisar ou digitar caminho...',
        searchWorktrees: 'Pesquisar worktrees...',
    },
    ...
    session: {
        ...
        resumedFrom: ({ name }: { name: string }) => `Retomada de ${name}`,
    ...
    agentInput: {
        ...
        fileTooLarge: ({ names, limit }: { names: string; limit: string }) => `Os seguintes arquivos excedem o limite de ${limit} e não foram anexados: ${names}`,
    },
