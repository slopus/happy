...
export const pt: TranslationStructure = {
    ...
    taskManager: {
        selectTask: 'Selecione uma tarefa para ver detalhes',
        machines: 'Máquinas',
        noMachines: 'Nenhuma máquina conectada',
        agents: 'Agentes',
        ...
        newTask: 'Nova Tarefa',
        machine: 'Máquina',
        noMachinesOnline: 'Nenhuma máquina online. Inicie um daemon primeiro.',
        agentType: 'Tipo de Agente',
        noAgentsOnMachine: 'Nenhum agente de código detectado nesta máquina.',
        model: 'Modelo',
        creating: 'Criando...',
        saving: 'Salvando...',
        ...
        mode: 'Modo',
        execute: 'Executar',
        executeHint: 'O agente age imediatamente',
        plan: 'Plano',
        planHint: 'O agente propõe um plano primeiro',
        yoloMode: 'YOLO Mode',
        yoloHint: 'Pular todas as solicitações de permissão (--dangerously-skip-permissions)',
        taskPrompt: 'O que o agente deve fazer?',
        taskPromptPlaceholder: 'Descreva a tarefa...',
        createPlan: 'Criar Plano',
        createTask: 'Criar Tarefa',
        taskNotFound: 'Tarefa não encontrada',
        agentWorking: 'Agente trabalhando...',
        agentDone: 'Agente concluiu',
        agentWaiting: 'Aguardando',
        agentLabel: 'Agente',
        complete: 'Concluído',
        noSession: 'Nenhuma sessão ainda. Aguardando o agente iniciar...',
        waitingMessages: 'Aguardando mensagens...',
        chatPlaceholder: 'Envie uma mensagem ao agente... (Cmd+Enter para enviar)',
        send: 'Enviar',
        you: 'Você',
        name: 'Nome',
    },
