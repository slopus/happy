...
export const pt: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        worktree: {
            ...
            createPRConfirm: ({ branch }: { branch: string }) => `Criar um Pull Request para a branch "${branch}"?`,
            ...
            mergeBranchSubtitle: 'Mesclar a branch do worktree na branch base',
            mergeConfirm: ({ branch }: { branch: string }) => `Mesclar "${branch}" na branch base?`,
            ...
            cleanupSubtitle: 'Excluir o diretório do worktree (a branch é preservada)',
            cleanupConfirm: 'Remover o worktree? A branch será preservada por segurança.',
            ...
            archiveAndCleanup: 'Arquivar e limpar',
    ...
    settingsVoice: {
        ...
        providerElevenLabsSubtitle: 'Serviço de voz IA na nuvem',
        providerHappyVoiceSubtitle: 'Gateway de voz auto-hospedado',
