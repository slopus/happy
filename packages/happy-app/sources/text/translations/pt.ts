...
export const pt: TranslationStructure = {
    ...
    relationshipAdvisorPlugin: {
        ...
        encryptionNotice: 'A configuração, incluindo a chave de API, é criptografada e armazenada no servidor da Paws. Depois de salva, a chave não é devolvida ao aplicativo.',
        apiKey: 'Chave de API',
