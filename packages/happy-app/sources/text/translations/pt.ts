...
export const pt: TranslationStructure = {
    ...
    settings: {
        ...
        mcpServersSubtitle: 'Gerenciar servidores Model Context Protocol',
    ...
    settingsMcp: {
        activeServers: 'Servidores ativos',
        activeServersFooter: 'As alterações se aplicam a novas sessões do Claude Code.',
        disabledServers: 'Servidores desativados',
    ...
    sessionInfo: {
        ...
        renameSessionDescription: 'Definir um nome personalizado para esta sessão',
        renameSessionClear: 'Limpar para redefinir para o nome gerado automaticamente',
        ...
        restartSessionConfirm: 'Reiniciar esta sessão? Ela será arquivada e retomada.',
        archiveAndDelete: 'Arquivar e excluir esta sessão?',
    ...
    claude: {
        ...
        permissions: {
            ...
            yesAllowAll: 'Sim, não perguntar novamente (permitir tudo)',
