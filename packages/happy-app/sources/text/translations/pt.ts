...
export const pt: TranslationStructure = {
    ...
    settingsFeatures: {
        ...
        copySessionIds: 'Copiar IDs de sessão',
        copySessionIdsSubtitle: 'Adiciona ações para copiar o ID da sessão ao menu de pressão longa',
    },
    ...
    sessionInfo: {
        ...
        copySessionId: 'Copiar ID da sessão Happy',
