...
export const pl: TranslationStructure = {
    ...
    relationshipAdvisorPlugin: {
        ...
        model: 'Model',
        modelPlaceholder: 'Nazwa modelu',
        testConnection: 'Testuj połączenie',
        testConnectionSubtitle: 'Wyślij minimalne żądanie z bieżącymi ustawieniami bez ich zapisywania',
    ...
    machine: {
        ...
        codexUsageHeatmap: 'Aktywność (ostatnie 14 dni)',
