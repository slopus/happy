...
export const pl: TranslationStructure = {
    ...
    taskManager: {
        ...
        machines: 'Maszyny',
        noMachines: 'Brak podłączonych maszyn',
        agents: 'Agenci',
        noAgents: 'Brak skonfigurowanych agentów',
        projects: 'Projekty',
        ...
        machine: 'Maszyna',
        noMachinesOnline: 'Brak maszyn online. Najpierw uruchom daemon.',
        agentType: 'Typ agenta',
        noAgentsOnMachine: 'Nie wykryto agentów kodu na tej maszynie.',
        model: 'Model',
        creating: 'Tworzenie...',
        saving: 'Zapisywanie...',
        githubRepo: 'Repozytorium GitHub',
        description: 'Opis',
        descriptionPlaceholder: 'O czym jest ten projekt?',
        project: 'Projekt',
        agent: 'Agent',
        mode: 'Tryb',
        execute: 'Wykonaj',
        executeHint: 'Agent działa natychmiast',
        plan: 'Plan',
        planHint: 'Agent najpierw proponuje plan',
        yoloMode: 'YOLO Mode',
        yoloHint: 'Pomiń wszystkie pytania o uprawnienia (--dangerously-skip-permissions)',
        taskPrompt: 'Co powinien zrobić agent?',
        taskPromptPlaceholder: 'Opisz zadanie...',
        createPlan: 'Utwórz plan',
        createTask: 'Utwórz zadanie',
        taskNotFound: 'Nie znaleziono zadania',
        agentWorking: 'Agent pracuje...',
        agentDone: 'Agent zakończył pracę',
        agentWaiting: 'Oczekiwanie',
        agentLabel: 'Agent',
        complete: 'Ukończone',
        noSession: 'Brak sesji. Oczekiwanie na uruchomienie agenta...',
        waitingMessages: 'Oczekiwanie na wiadomości...',
        chatPlaceholder: 'Wyślij wiadomość do agenta... (Cmd+Enter aby wysłać)',
        send: 'Wyślij',
        you: 'Ty',
        name: 'Nazwa',
    },
