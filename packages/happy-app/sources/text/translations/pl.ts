...
export const pl: TranslationStructure = {
    ...
    openclaw: {
        ...
        initialMessagePlaceholder: 'Nad czym chciałbyś pracować?',
    ...
    sessionInfo: {
        ...
        updateCliInstructions: 'Proszę uruchomić npm install -g happy-code-cli@latest',
        ...
        worktree: {
            ...
            createPRConfirm: ({ branch }: { branch: string }) => `Utworzyć Pull Request dla gałęzi "${branch}"?`,
            ...
            mergeBranchSubtitle: 'Scal gałąź worktree z gałęzią bazową',
            mergeConfirm: ({ branch }: { branch: string }) => `Scalić "${branch}" z gałęzią bazową?`,
            ...
            cleanupSubtitle: 'Usuń katalog worktree (gałąź zostanie zachowana)',
            cleanupConfirm: 'Usunąć worktree? Gałąź zostanie zachowana dla bezpieczeństwa.',
    ...
    machine: {
        ...
        offlineHelp: '• Upewnij się, że komputer jest online\n• Uruchom `happy daemon status`, aby zdiagnozować\n• Czy używasz najnowszej wersji CLI? Zaktualizuj poleceniem `npm install -g happy-code-cli@latest`',
