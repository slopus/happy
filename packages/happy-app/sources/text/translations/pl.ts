...
export const pl: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        renameSessionDescription: 'Ustaw własną nazwę dla tej sesji',
        renameSessionClear: 'Wyczyść, aby przywrócić automatycznie wygenerowaną nazwę',
        ...
        restartSession: 'Uruchom ponownie',
        restartSessionConfirm: 'Uruchomić ponownie tę sesję? Zostanie zarchiwizowana i wznowiona.',
        archiveAndDelete: 'Zarchiwizować i usunąć tę sesję?',
    },
    ...
    claude: {
        ...
        permissions: {
            ...
            yesAllowAll: 'Tak, nie pytaj ponownie (zezwól na wszystko)',
