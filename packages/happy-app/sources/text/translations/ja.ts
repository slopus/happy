...
export const ja: TranslationStructure = {
    ...
    taskManager: {
        ...
        machines: 'マシン',
        noMachines: '接続されたマシンがありません',
        agents: 'エージェント',
        noAgents: 'エージェントが設定されていません',
        projects: 'プロジェクト',
        ...
        newTask: '新しいタスク',
        machine: 'マシン',
        noMachinesOnline: 'オンラインのマシンがありません。まずdaemonを起動してください。',
        agentType: 'エージェントタイプ',
        noAgentsOnMachine: 'このマシンでコードエージェントが検出されませんでした。',
        model: 'モデル',
        creating: '作成中...',
        saving: '保存中...',
        githubRepo: 'GitHubリポジトリ',
        description: '説明',
        descriptionPlaceholder: 'このプロジェクトについて教えてください',
        project: 'プロジェクト',
        agent: 'エージェント',
        mode: 'モード',
        execute: '実行',
        executeHint: 'エージェントが即座に実行します',
        plan: 'プラン',
        planHint: 'エージェントがまずプランを提案します',
        yoloMode: 'YOLO Mode',
        yoloHint: 'すべての権限プロンプトをスキップ (--dangerously-skip-permissions)',
        taskPrompt: 'エージェントに何をさせますか？',
        taskPromptPlaceholder: 'タスクを説明してください...',
        createPlan: 'プランを作成',
        createTask: 'タスクを作成',
        taskNotFound: 'タスクが見つかりません',
        agentWorking: 'エージェント作業中...',
        agentDone: 'エージェント完了',
        agentWaiting: '待機中',
        agentLabel: 'エージェント',
        complete: '完了',
        noSession: 'セッションがまだありません。エージェントの起動を待っています...',
        waitingMessages: 'メッセージを待っています...',
        chatPlaceholder: 'エージェントにメッセージを送信... (Cmd+Enterで送信)',
        send: '送信',
        you: 'あなた',
        name: '名前',
    },
