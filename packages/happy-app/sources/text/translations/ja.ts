...
export const ja: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        worktree: {
            ...
            createPRConfirm: ({ branch }: { branch: string }) => `ブランチ "${branch}" の Pull Request を作成しますか？`,
            ...
            mergeBranchSubtitle: 'worktree ブランチをベースブランチにマージ',
            mergeConfirm: ({ branch }: { branch: string }) => `"${branch}" をベースブランチにマージしますか？`,
            ...
            cleanupSubtitle: 'worktree ディレクトリを削除（ブランチは保持）',
            cleanupConfirm: 'worktree を削除しますか？ブランチは安全のため保持されます。',
