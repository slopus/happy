...
export const ru: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        updateCliInstructions: 'Пожалуйста, выполните npm install -g happy-code-cli@latest',
        ...
        worktree: {
            ...
            createPRConfirm: ({ branch }: { branch: string }) => `Создать Pull Request для ветки "${branch}"?`,
            ...
            mergeBranchSubtitle: 'Слить ветку worktree с базовой веткой',
            mergeConfirm: ({ branch }: { branch: string }) => `Слить "${branch}" с базовой веткой?`,
            ...
            cleanupSubtitle: 'Удалить каталог worktree (ветка сохраняется)',
            cleanupConfirm: 'Удалить worktree? Ветка будет сохранена для безопасности.',
