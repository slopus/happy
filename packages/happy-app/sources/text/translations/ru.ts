...
export const ru: TranslationStructure = {
    ...
    settingsVoice: {
        ...
        usageTitle: 'Использование (текущий период)',
        usageFooter: 'Использование голоса за текущий период лимита. Бесплатно: 20 мин. С подпиской: 5 часов. Макс. 100 разговоров за период.',
