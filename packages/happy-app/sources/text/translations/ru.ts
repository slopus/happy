...
export const ru: TranslationStructure = {
    ...
    taskManager: {
        selectTask: 'Выберите задачу для просмотра деталей',
        machines: 'Машины',
        ...
        machine: 'Машина',
        noMachinesOnline: 'Нет машин в сети. Сначала запустите daemon.',
        agentType: 'Тип агента',
        noAgentsOnMachine: 'На этой машине не обнаружено агентов кода.',
        model: 'Модель',
        creating: 'Создание...',
        saving: 'Сохранение...',
        ...
        mode: 'Режим',
        execute: 'Выполнить',
        executeHint: 'Агент действует немедленно',
        plan: 'План',
        planHint: 'Агент сначала предлагает план',
        yoloMode: 'YOLO Mode',
        yoloHint: 'Пропустить все запросы разрешений (--dangerously-skip-permissions)',
        taskPrompt: 'Что должен сделать агент?',
        taskPromptPlaceholder: 'Опишите задачу...',
        createPlan: 'Создать план',
        createTask: 'Создать задачу',
        taskNotFound: 'Задача не найдена',
        agentWorking: 'Агент работает...',
        agentDone: 'Агент завершил работу',
        agentWaiting: 'Ожидание',
        agentLabel: 'Агент',
        complete: 'Завершено',
        noSession: 'Сессия ещё не началась. Ожидание запуска агента...',
        waitingMessages: 'Ожидание сообщений...',
        chatPlaceholder: 'Отправьте сообщение агенту... (Cmd+Enter для отправки)',
        send: 'Отправить',
        you: 'Вы',
        name: 'Название',
    },
