...
export const ru: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        renameSessionDescription: 'Задать пользовательское имя для этой сессии',
        renameSessionClear: 'Очистить для сброса к автоматически сгенерированному имени',
        ...
        restartSession: 'Перезапуск',
        restartSessionConfirm: 'Перезапустить сессию? Она будет архивирована и возобновлена.',
        ...
        archiveAndDelete: 'Архивировать и удалить эту сессию?',
