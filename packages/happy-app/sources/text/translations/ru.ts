...
export const ru: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        updateCliInstructions: 'Пожалуйста, выполните npm install -g slaphappy@latest',
