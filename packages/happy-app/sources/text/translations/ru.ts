...
export const ru: TranslationStructure = {
    ...
    agents: {
        ...
        imageStyleHealingScribbleSketchHint: 'Превратите портрет в уютного аниме-персонажа с выразительным лицом, живыми эскизными линиями, выборочной светлой акварелью и большим количеством белой бумаги.\nУзнаваемость сохраняют форма лица, волосы, очки, выражение и ключевые детали одежды; текст добавляется только по запросу.',
