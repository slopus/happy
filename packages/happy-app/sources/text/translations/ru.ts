...
export const ru: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        updateCliInstructions: 'Пожалуйста, выполните npm install -g happy-blue@latest',
