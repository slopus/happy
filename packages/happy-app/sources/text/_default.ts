...
export const en = {
    ...
    taskManager: {
        // Task manager (web only) — project/agent/task orchestration
        ...
        newTask: 'New Task',
        machine: 'Machine',
        noMachinesOnline: 'No machines online. Start a daemon first.',
        agentType: 'Agent Type',
        noAgentsOnMachine: 'No code agents detected on this machine.',
        model: 'Model',
        creating: 'Creating...',
        saving: 'Saving...',
        ...
        mode: 'Mode',
        execute: 'Execute',
        executeHint: 'Agent acts immediately',
        plan: 'Plan',
        planHint: 'Agent proposes a plan first',
        yoloMode: 'YOLO Mode',
        yoloHint: 'Skip all permission prompts (--dangerously-skip-permissions)',
        taskPrompt: 'What should the agent do?',
        taskPromptPlaceholder: 'Describe the task...',
        ...
        agentLabel: 'Agent',
        complete: 'Complete',
        noSession: 'No session yet. Waiting for agent to start...',
        waitingMessages: 'Waiting for messages...',
        chatPlaceholder: 'Send a message to the agent... (Cmd+Enter to send)',
        send: 'Send',
        you: 'You',
        name: 'Name',
    },
