...
export const en = {
    ...
    sessionInfo: {
        ...
        worktree: {
            ...
            createPRConfirm: ({ branch }: { branch: string }) => `Create a pull request for branch "${branch}"?`,
            ...
            mergeBranchSubtitle: 'Merge the worktree branch back to the base branch',
            mergeConfirm: ({ branch }: { branch: string }) => `Merge "${branch}" into the base branch?`,
            ...
            cleanupSubtitle: 'Delete the worktree directory (branch is preserved)',
            cleanupConfirm: 'Remove the worktree? The branch will be preserved for safety.',
