...
import { WORKTREE_DIR, WORKTREE_PATH_MARKER } from '@/utils/projectPath';

// Pure path logic lives in utils/projectPath (no RN/RPC deps, so it is unit
// testable); re-exported here so existing import sites are unaffected.
export {
    WORKTREE_DIR,
