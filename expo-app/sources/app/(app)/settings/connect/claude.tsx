...
export default function ClaudeOAuth() {
    ...
    return (
        <>
            <OAuthViewUnsupported name="Claude" command="runline connect claude" />
            {/* <OAuthView
                name="Claude"
                command="runline connect claude"
...
const OAuthViewUnsupported = React.memo((props: {
    ...
    const command = props.command || `runline connect ${props.name.toLowerCase()}`;
