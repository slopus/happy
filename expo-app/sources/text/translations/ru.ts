...
export const ru: TranslationStructure = {
    ...
    clawdbot: {
        ...
        notConnectedDescription: 'Подключитесь к шлюзу Clawdbot, чтобы начать общение.',
        connectToGateway: 'Подключиться к шлюзу',
        connectTitle: 'Подключение к Clawdbot',
        connectDescription: 'Введите URL вашего шлюза Clawdbot. Шлюз работает локально на вашем компьютере.',
        connectionSettings: 'Настройки подключения',
        gatewayUrl: 'URL шлюза',
        token: 'Токен доступа',
        tokenDescription: 'Получите через CLI или панель управления clawdbot',
        ...
        connectFooter: 'Подключение напрямую к вашему локальному шлюзу. Данные не проходят через внешние серверы.',
        localConnection: 'Локальное подключение',
        localConnectionDescription: 'Вся коммуникация происходит напрямую с вашим шлюзом.',
        ...
        chat: 'Чат',
        startConversation: 'Начните разговор с Clawdbot',
        messagePlaceholder: 'Введите сообщение...',
        pairingRequired: 'Требуется сопряжение',
        pairingDescription: 'Это устройство должно быть одобрено для подключения к шлюзу.',
        pairingInstructions: 'Как одобрить',
        pairingStep1Title: 'Откройте Clawdbot',
        pairingStep1Description: 'Нажмите на значок Clawdbot в строке меню',
        ...
        pairingStep3Description: 'Нажмите "Одобрить" для подключения этого устройства',
        retryConnection: 'Повторить подключение',
        deviceInfo: 'Информация об устройстве',
        deviceId: 'ID устройства',
        newSession: 'Новая сессия',
        newSessionTitle: 'Начать новый разговор',
        newSessionDescription: 'Введите сообщение ниже, чтобы начать общение с Clawdbot.',
        ...
        tokenCommandDescription: 'Это выведет URL с вашим токеном. Скопируйте значение после "?token="',
    },
} as const;
