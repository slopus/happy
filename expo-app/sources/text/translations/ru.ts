...
export const ru: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        updateCliInstructions: 'Пожалуйста, выполните npm install -g @runline/arc@latest',
    ...
    machine: {
        ...
        offlineHelp: '• Убедитесь, что компьютер online\n• Выполните `runline daemon status` для диагностики\n• Используете последнюю версию CLI? Обновите командой `npm install -g @runline/arc@latest`',
