...
export const ru: TranslationStructure = {
    ...
    moltbot: {
        ...
        emptyDescription: 'Добавьте шлюз Moltbot, чтобы начать общаться с Claude',
        ...
        noSessionsDescription: 'Начните новую сессию для общения с Claude',
        ...
        sessionTypeDirectDescription: 'Приватный разговор с Claude на этой машине',
