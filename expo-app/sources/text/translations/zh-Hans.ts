...
export const zhHans: TranslationStructure = {
    ...
    clawdbot: {
        ...
        disconnect: '断开',
        notConnected: '未连接',
        notConnectedDescription: '连接到您的Clawdbot网关以开始聊天。',
        connectToGateway: '连接到网关',
        connectTitle: '连接到Clawdbot',
        connectDescription: '输入您的Clawdbot网关URL。网关在您的本地计算机上运行。',
        connectionSettings: '连接设置',
        gatewayUrl: '网关URL',
        token: '访问令牌',
        tokenDescription: '通过clawdbot CLI或控制面板生成',
        ...
        chat: '聊天',
        startConversation: '开始与Clawdbot对话',
        messagePlaceholder: '输入消息...',
        pairingRequired: '需要配对',
        pairingDescription: '此设备需要在连接前获得您的 Clawdbot 网关批准。这是一次性设置。',
        pairingInstructions: '如何批准',
        pairingStep1Title: '打开 Clawdbot',
        pairingStep1Description: '点击菜单栏或系统托盘中的 Clawdbot 图标',
        ...
        newSessionDescription: '在下方输入消息开始与 Clawdbot 聊天。',
