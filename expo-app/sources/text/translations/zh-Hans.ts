...
export const zhHans: TranslationStructure = {
    ...
    session: {
        ...
        sharing: {
            ...
            shareNotFound: '分享链接未找到或已被撤销',
            shareExpired: '此分享链接已过期',
            failedToDecrypt: '无法解密分享信息',
            consentDescription: '接受即表示您同意记录您的访问信息',
            acceptAndView: '接受并查看',
            days7: '7 天',
            days30: '30 天',
            never: '永不过期',
            ...
            uses50: '50 次使用',
            maxUsesLabel: '最大使用次数',
            publicLinkDescription: '创建一个任何人都可以用来访问此会话的可分享链接',
            expiresIn: '链接过期时间',
            requireConsentDescription: '用户在访问前必须同意',
            linkToken: '链接令牌',
            expiresOn: '过期日期',
            usageCount: '使用次数',
