...
export const zhHans: TranslationStructure = {
    ...
    moltbot: {
        emptyTitle: '没有 Moltbot 机器',
        emptyDescription: '添加 Moltbot 网关以开始与 Claude 聊天',
        addMachine: '添加机器',
        machineType: '机器类型',
        machineTypeHappy: 'Happy 机器',
        machineTypeHappyDescription: '通过电脑上的 Happy 机器连接',
        machineTypeDirect: '直接连接',
        machineTypeDirectDescription: '直接连接到 Moltbot 网关',
        gatewayUrl: '网关 URL',
        ...
        newSession: '新建会话',
        noSessions: '没有会话',
        noSessionsDescription: '开始新会话以与 Claude 聊天',
        unknownMachine: '未知机器',
        ...
        sessionTypeDirectDescription: '在此机器上与 Claude 的私人对话',
    ...
    sessionInfo: {
        ...
        updateCliInstructions: '请运行 npm install -g happy-code-cli@latest',
        deleteSession: '删除会话',
    ...
    machine: {
        ...
        offlineHelp: '• 确保您的计算机在线\n• 运行 `happy daemon status` 进行诊断\n• 您是否在运行最新的 CLI 版本？请使用 `npm install -g happy-code-cli@latest` 升级',
        daemon: '守护进程',
        status: '状态',
        stopDaemon: '停止守护进程',
