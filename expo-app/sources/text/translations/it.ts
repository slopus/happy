...
export const it: TranslationStructure = {
    ...
    moltbot: {
        emptyTitle: 'Nessuna macchina Moltbot',
        emptyDescription: 'Aggiungi un gateway Moltbot per iniziare a chattare con Claude',
        ...
        machineTypeDirectDescription: 'Connetti direttamente a un gateway Moltbot',
        ...
        noSessionsDescription: 'Inizia una nuova sessione per chattare con Claude',
        ...
        sessionTypeDirectDescription: 'Conversazione privata con Claude su questa macchina',
        ...
        initialMessagePlaceholder: 'Su cosa vorresti lavorare?',
    ...
    sessionInfo: {
        ...
        updateCliInstructions: 'Esegui npm install -g happy-code-cli@latest',
