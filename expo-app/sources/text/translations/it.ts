...
export const it: TranslationStructure = {
    ...
    clawdbot: {
        ...
        notConnectedDescription: 'Connettiti al gateway Clawdbot per iniziare a chattare.',
        connectToGateway: 'Connetti al gateway',
        connectTitle: 'Connetti a Clawdbot',
        connectDescription: 'Inserisci l\'URL del tuo gateway Clawdbot. Il gateway funziona localmente sul tuo computer.',
        connectionSettings: 'Impostazioni di connessione',
        gatewayUrl: 'URL del gateway',
        token: 'Token di accesso',
        tokenDescription: 'Genera dal CLI o pannello di controllo di clawdbot',
        ...
        connectFooter: 'La tua connessione è diretta al gateway locale. I dati non passano attraverso server esterni.',
        localConnection: 'Connessione locale',
        localConnectionDescription: 'Tutta la comunicazione avviene direttamente con il tuo gateway.',
        ...
        chat: 'Chat',
        startConversation: 'Inizia una conversazione con Clawdbot',
        messagePlaceholder: 'Scrivi un messaggio...',
        pairingRequired: 'Abbinamento richiesto',
        pairingDescription: 'Questo dispositivo deve essere approvato dal tuo gateway Clawdbot prima di potersi connettere. Questa è una configurazione iniziale.',
        pairingInstructions: 'Come approvare',
        pairingStep1Title: 'Apri Clawdbot',
        pairingStep1Description: 'Clicca sull\'icona Clawdbot nella barra dei menu o nel vassoio di sistema',
        pairingStep2Title: 'Trova la richiesta di abbinamento',
        pairingStep2Description: 'Cerca "Happy" nell\'elenco dei dispositivi in attesa',
        pairingStep3Title: 'Approva il dispositivo',
        pairingStep3Description: 'Clicca "Approva" per consentire a questo dispositivo di connettersi',
        ...
        newSessionDescription: 'Scrivi il tuo messaggio qui sotto per iniziare a chattare con Clawdbot.',
        ...
        tokenCommandDescription: 'Questo mostrerà un URL con il tuo token. Copia il valore dopo "?token="',
    },
} as const;
