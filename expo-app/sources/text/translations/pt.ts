...
export const pt: TranslationStructure = {
    ...
    moltbot: {
        emptyTitle: 'Sem máquinas Moltbot',
        emptyDescription: 'Adicione um gateway Moltbot para começar a conversar com Claude',
        ...
        machineTypeDirectDescription: 'Conectar diretamente a um gateway Moltbot',
        ...
        noSessionsDescription: 'Inicie uma nova sessão para conversar com Claude',
        ...
        sessionTypeDirectDescription: 'Conversa privada com Claude nesta máquina',
        ...
        initialMessagePlaceholder: 'No que você gostaria de trabalhar?',
    ...
    sessionHistory: {
        ...
        resumeConfirmMessage: 'Isto retomará a sessão do Claude no seu dispositivo conectado.',
    },
    ...
    sessionInfo: {
        ...
        updateCliInstructions: 'Por favor execute npm install -g happy-code-cli@latest',
