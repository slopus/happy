...
export const pt: TranslationStructure = {
    ...
    clawdbot: {
        ...
        notConnectedDescription: 'Conecte-se ao gateway Clawdbot para começar a conversar.',
        connectToGateway: 'Conectar ao gateway',
        connectTitle: 'Conectar ao Clawdbot',
        connectDescription: 'Insira o URL do seu gateway Clawdbot. O gateway funciona localmente no seu computador.',
        connectionSettings: 'Configurações de conexão',
        gatewayUrl: 'URL do gateway',
        token: 'Token de acesso',
        tokenDescription: 'Gere pelo CLI ou painel de controle do clawdbot',
        ...
        connectFooter: 'Sua conexão é direta com o gateway local. Os dados não passam por servidores externos.',
        localConnection: 'Conexão local',
        localConnectionDescription: 'Toda a comunicação acontece diretamente com seu gateway.',
        ...
        chat: 'Chat',
        startConversation: 'Inicie uma conversa com Clawdbot',
        messagePlaceholder: 'Digite uma mensagem...',
        pairingRequired: 'Emparelhamento necessário',
        pairingDescription: 'Este dispositivo precisa ser aprovado pelo seu gateway Clawdbot antes de poder conectar. Esta é uma configuração única.',
        pairingInstructions: 'Como aprovar',
        pairingStep1Title: 'Abra o Clawdbot',
        pairingStep1Description: 'Clique no ícone do Clawdbot na barra de menu ou bandeja do sistema',
        pairingStep2Title: 'Encontre a solicitação de emparelhamento',
        pairingStep2Description: 'Procure "Happy" na lista de dispositivos pendentes',
        pairingStep3Title: 'Aprove o dispositivo',
        pairingStep3Description: 'Clique em "Aprovar" para permitir que este dispositivo se conecte',
        retryConnection: 'Tentar novamente',
        deviceInfo: 'Info do dispositivo',
        deviceId: 'ID do dispositivo',
        newSession: 'Nova sessão',
        newSessionTitle: 'Iniciar uma nova conversa',
        newSessionDescription: 'Digite sua mensagem abaixo para começar a conversar com o Clawdbot.',
        ...
        tokenCommandDescription: 'Isso mostrará uma URL com seu token. Copie o valor após "?token="',
    },
} as const;
