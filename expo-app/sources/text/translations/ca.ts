...
export const ca: TranslationStructure = {
    ...
    clawdbot: {
        ...
        notConnectedDescription: 'Connecta\'t a la passarel·la Clawdbot per començar a xatejar.',
        connectToGateway: 'Connectar a la passarel·la',
        connectTitle: 'Connectar a Clawdbot',
        connectDescription: 'Introdueix l\'URL de la teva passarel·la Clawdbot. La passarel·la s\'executa localment al teu ordinador.',
        connectionSettings: 'Configuració de connexió',
        gatewayUrl: 'URL de la passarel·la',
        token: 'Token d\'accés',
        tokenDescription: 'Genera des del CLI o panell de control de clawdbot',
        ...
        checkSettings: 'Comprova la configuració de connexió i torna-ho a provar.',
        connectFooter: 'La teva connexió és directa a la passarel·la local. Les dades no passen per servidors externs.',
        localConnection: 'Connexió local',
        localConnectionDescription: 'Tota la comunicació es fa directament amb la teva passarel·la.',
        ...
        chat: 'Xat',
        startConversation: 'Comença una conversa amb Clawdbot',
        messagePlaceholder: 'Escriu un missatge...',
        pairingRequired: 'Emparellament requerit',
        pairingDescription: 'Aquest dispositiu ha de ser aprovat abans de connectar-se a la passarel·la.',
        pairingInstructions: 'Com aprovar',
        pairingStep1Title: 'Obre Clawdbot',
        pairingStep1Description: 'Fes clic a la icona de Clawdbot a la barra de menú',
        pairingStep2Title: 'Troba la sol·licitud d\'emparellament',
        pairingStep2Description: 'Cerca "Happy" a la llista de dispositius pendents',
        pairingStep3Title: 'Aprova el dispositiu',
        pairingStep3Description: 'Fes clic a "Aprovar" per permetre la connexió',
        ...
        newSessionDescription: 'Escriu el teu missatge a continuació per començar a xatejar amb Clawdbot.',
        ...
        tokenCommandDescription: 'Això mostrarà una URL amb el teu token. Copia el valor després de "?token="',
    },
} as const;
