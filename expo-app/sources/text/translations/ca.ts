...
export const ca: TranslationStructure = {
    ...
    moltbot: {
        emptyTitle: 'Sense màquines Moltbot',
        emptyDescription: 'Afegeix una passarel·la Moltbot per començar a xatejar amb Claude',
        ...
        machineTypeDirectDescription: 'Connectar directament a una passarel·la Moltbot',
        ...
        noSessionsDescription: 'Inicia una nova sessió per xatejar amb Claude',
        ...
        sessionTypeDirectDescription: 'Conversa privada amb Claude en aquesta màquina',
        ...
        initialMessagePlaceholder: 'En què t\'agradaria treballar?',
    ...
    session: {
        ...
        selectImageSource: 'Selecciona la font de la imatge',
    ...
    sessionInfo: {
        ...
        updateCliInstructions: 'Si us plau executeu npm install -g happy-code-cli@latest',
