...
export const ja: TranslationStructure = {
    ...
    clawdbot: {
        ...
        disconnect: '切断',
        notConnected: '未接続',
        notConnectedDescription: 'Clawdbotゲートウェイに接続してチャットを開始してください。',
        connectToGateway: 'ゲートウェイに接続',
        connectTitle: 'Clawdbotに接続',
        connectDescription: 'ClawdbotゲートウェイのURLを入力してください。ゲートウェイはローカルコンピュータ上で動作します。',
        connectionSettings: '接続設定',
        gatewayUrl: 'ゲートウェイURL',
        token: 'アクセストークン',
        tokenDescription: 'clawdbot CLIまたはコントロールUIから生成',
        ...
        connectFooter: '接続はローカルゲートウェイへの直接接続です。データは外部サーバーを経由しません。',
        ...
        chat: 'チャット',
        startConversation: 'Clawdbotとの会話を開始',
        messagePlaceholder: 'メッセージを入力...',
        pairingRequired: 'ペアリングが必要',
        pairingDescription: 'このデバイスは接続前にClawdbotゲートウェイで承認される必要があります。これは初回のみの設定です。',
        pairingInstructions: '承認方法',
        pairingStep1Title: 'Clawdbotを開く',
        pairingStep1Description: 'メニューバーまたはシステムトレイのClawdbotアイコンをクリック',
        pairingStep2Title: 'ペアリングリクエストを探す',
        pairingStep2Description: '保留中のデバイスリストで「Happy」を探してください',
        ...
        newSessionDescription: '下にメッセージを入力してClawdbotとチャットを始めましょう。',
        ...
        tokenCommandDescription: 'トークン付きのURLが表示されます。"?token="の後の値をコピーしてください',
    },
} as const;
