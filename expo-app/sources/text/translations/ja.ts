...
export const ja: TranslationStructure = {
    ...
    moltbot: {
        ...
        emptyDescription: 'Moltbot ゲートウェイを追加して Claude とチャットを開始',
        addMachine: 'マシンを追加',
        machineType: 'マシンタイプ',
        ...
        noSessionsDescription: '新しいセッションを開始して Claude とチャット',
        ...
        sessionTypeDirectDescription: 'Claude との1対1の会話',
    ...
    sessionInfo: {
        ...
        updateCliInstructions: 'npm install -g happy-code-cli@latest を実行してください',
