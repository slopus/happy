...
export const es: TranslationStructure = {
    ...
    moltbot: {
        emptyTitle: 'Sin máquinas Moltbot',
        emptyDescription: 'Añade una puerta de enlace Moltbot para empezar a chatear con Claude',
        ...
        machineTypeDirectDescription: 'Conectar directamente a una puerta de enlace Moltbot',
        gatewayUrl: 'URL de la puerta de enlace',
        gatewayPassword: 'Contraseña de la puerta de enlace',
        ...
        noSessionsDescription: 'Inicia una nueva sesión para chatear con Claude',
        ...
        sessionTypeDirectDescription: 'Conversación privada con Claude en esta máquina',
    ...
    sessionInfo: {
        ...
        updateCliInstructions: 'Por favor ejecute npm install -g happy-code-cli@latest',
