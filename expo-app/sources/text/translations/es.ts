...
export const es: TranslationStructure = {
    ...
    clawdbot: {
        ...
        notConnectedDescription: 'Conéctate a tu puerta de enlace Clawdbot para comenzar a chatear.',
        connectToGateway: 'Conectar a la puerta de enlace',
        connectTitle: 'Conectar a Clawdbot',
        connectDescription: 'Introduce la URL de tu puerta de enlace Clawdbot. La puerta de enlace se ejecuta localmente en tu computadora.',
        connectionSettings: 'Configuración de conexión',
        gatewayUrl: 'URL de la puerta de enlace',
        token: 'Token de acceso',
        tokenDescription: 'Generar desde CLI o panel de control de clawdbot',
        ...
        connectFooter: 'Tu conexión es directa a tu puerta de enlace local. Los datos no pasan por servidores externos.',
        localConnection: 'Conexión local',
        localConnectionDescription: 'Toda la comunicación ocurre directamente con tu puerta de enlace.',
        ...
        chat: 'Chat',
        startConversation: 'Inicia una conversación con Clawdbot',
        messagePlaceholder: 'Escribe un mensaje...',
        pairingRequired: 'Emparejamiento requerido',
        pairingDescription: 'Este dispositivo debe ser aprobado antes de conectarse a la puerta de enlace.',
        pairingInstructions: 'Cómo aprobar',
        pairingStep1Title: 'Abre Clawdbot',
        pairingStep1Description: 'Haz clic en el icono de Clawdbot en la barra de menú',
        pairingStep2Title: 'Encuentra la solicitud de emparejamiento',
        pairingStep2Description: 'Busca "Happy" en la lista de dispositivos pendientes',
        ...
        newSessionDescription: 'Escribe tu mensaje abajo para empezar a chatear con Clawdbot.',
        ...
        tokenCommandDescription: 'Esto mostrará una URL con tu token. Copia el valor después de "?token="',
    },
} as const;
