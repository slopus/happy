...
export const es: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        updateCliInstructions: 'Por favor ejecute npm install -g @runline/arc@latest',
    ...
    welcome: {
        ...
        linkYourRunners: 'Vincula tus Runners',
        withYourMobile: 'con tu móvil',
    },
    ...
    machine: {
        ...
        offlineHelp: '• Asegúrate de que tu computadora esté en línea\n• Ejecuta `runline daemon status` para diagnosticar\n• ¿Estás usando la última versión del CLI? Actualiza con `npm install -g @runline/arc@latest`',
