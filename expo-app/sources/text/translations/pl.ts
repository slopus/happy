...
export const pl: TranslationStructure = {
    ...
    clawdbot: {
        ...
        notConnectedDescription: 'Połącz się z bramką Clawdbot, aby rozpocząć rozmowę.',
        connectToGateway: 'Połącz z bramką',
        connectTitle: 'Połącz z Clawdbot',
        connectDescription: 'Wprowadź adres URL bramki Clawdbot. Bramka działa lokalnie na twoim komputerze.',
        connectionSettings: 'Ustawienia połączenia',
        gatewayUrl: 'Adres URL bramki',
        token: 'Token dostępu',
        tokenDescription: 'Wygeneruj przez CLI lub panel sterowania clawdbot',
        ...
        connectFooter: 'Połączenie jest bezpośrednie z lokalną bramką. Dane nie przechodzą przez zewnętrzne serwery.',
        localConnection: 'Połączenie lokalne',
        localConnectionDescription: 'Cała komunikacja odbywa się bezpośrednio z twoją bramką.',
        ...
        chat: 'Czat',
        startConversation: 'Rozpocznij rozmowę z Clawdbot',
        messagePlaceholder: 'Wpisz wiadomość...',
        pairingRequired: 'Wymagane parowanie',
        pairingDescription: 'To urządzenie musi zostać zatwierdzone przed połączeniem z bramką.',
        pairingInstructions: 'Jak zatwierdzić',
        pairingStep1Title: 'Otwórz Clawdbot',
        pairingStep1Description: 'Kliknij ikonę Clawdbot na pasku menu',
        ...
        newSessionDescription: 'Wpisz wiadomość poniżej, aby rozpocząć czat z Clawdbot.',
        ...
        tokenCommandDescription: 'To wyświetli URL z twoim tokenem. Skopiuj wartość po "?token="',
    },
} as const;
