...
export const en = {
    ...
    sessionInfo: {
        ...
        updateCliInstructions: 'Please run npm install -g @runline/arc@latest',
    ...
    machine: {
        ...
        offlineHelp: '• Make sure your computer is online\n• Run `runline daemon status` to diagnose\n• Are you running the latest CLI version? Upgrade with `npm install -g @runline/arc@latest`',
        daemon: 'Daemon',
        status: 'Status',
