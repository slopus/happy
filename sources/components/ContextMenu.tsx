...
export const ContextMenu: React.FC<ContextMenuProps> = ({
  ...
  const handleActionPress = React.useCallback((action: ContextMenuAction) => {
    ...
    <View key={section.id}>
      ...
      <View style={styles.sectionContent}>
        {section.actions.map((action, actionIndex) =>
          renderAction(action, actionIndex === section.actions.length - 1 && sectionIndex === normalizedSections.length - 1),
        )}
      </View>
