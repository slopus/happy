...
import { verifyPassword, isPasswordProtectionEnabled } from '@/auth/passwordSecurity';
            ...
            if (isValid) {
                ...
                if (newAttempts >= 5) {
                    ...
                    Modal.alert(
                        ...
                        t('password.incorrectPasswordMessage', { attempts: 5 - newAttempts })
                    );
                }
            }
        } catch (error) {
            ...
            <View style={styles.form}>
                ...
                <Pressable
                    style={[
                        styles.unlockButton,
                        {
                            backgroundColor: password.trim() && !isLoading
                                ? theme.colors.text
