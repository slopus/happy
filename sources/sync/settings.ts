...
export const SettingsSchema = z.object({
	...
	defaultCoder: z
		...
		.describe(
			"Default coder/AI provider for new sessions: claude, codex, or ask each time",
		),
	anonymousMode: z
		.boolean()
		.describe(
			"Whether to use anonymous mode to hide user identity and personal information",
		),
	desktopWindowWidth: z
		.number()
		.nullable()
		.describe("Preferred desktop window width (null for auto-sizing)"),
	desktopWindowHeight: z
		.number()
		.nullable()
		.describe("Preferred desktop window height (null for auto-sizing)"),
	desktopWindowMaximized: z
		.boolean()
		.describe("Whether desktop window should be maximized"),
});
