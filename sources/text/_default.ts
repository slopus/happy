...
export const en = {
  ...
  password: {
    ...
    incorrectPasswordMessage: ({ attempts }: { attempts: number }) => `Incorrect password. ${attempts} attempt${attempts === 1 ? '' : 's'} remaining.`,
    tooManyAttempts: 'Too Many Attempts',
    tooManyAttemptsMessage: 'Too many failed password attempts. Please try biometric authentication or reset the app.',
    attemptsRemaining: ({ attempts }: { attempts: number }) => `${attempts} attempt${attempts === 1 ? '' : 's'} remaining`,
    ...
    forgotPasswordMessage: 'Forgetting your password will reset the app and you will need to restore your account using your secret key.',
    resetApp: 'Reset App',
    ...
    disablePasswordMessage: 'Are you sure you want to disable password protection? Your sessions will be accessible without a password.',
    ...
    resetPasswordBiometric: 'Your identity has been verified. This will remove password protection while keeping your session data safe.',
    resetPassword: 'Reset Password',
    resetAppTitle: 'Reset Application',
    resetAppWarning: 'This will delete ALL your data including sessions, settings, and account information. This cannot be undone.',
    resetAppDescription: 'Remove all data and start fresh',
    confirmReset: 'Are you absolutely sure?',
    confirmResetMessage: 'This will permanently delete everything. You will need to restore your account using your secret key.',
  ...
  passwordMigration: {
    ...
    description: 'Add password protection to keep your coding sessions secure. Your data stays private with optional biometric unlock.',
    setupNow: 'Set Up Now',
