...
export const en = {
	...
	settingsFeatures: {
		...
		defaultCoderDescription:
			"Choose which AI assistant to use for new sessions by default.",
		defaultCoderClaude: "Claude Code",
		defaultCoderCodex: "Codex",
		defaultCoderAsk: "Ask Each Time",
		privacy: "Privacy",
		privacyDescription:
			"Control how your personal information is displayed and shared.",
		anonymousModeDisabled: "Show real name and profile",
		aiModels: "AI Models",
		aiModelsDescription:
			"Automatically discovered AI models and their capabilities. Tap to refresh model list.",
	...
	sessionInfo: {
		...
		updateCliSuccess:
			"CLI updated successfully! Session will refresh automatically.",
		updateCliError: "Failed to update CLI. Please try manual update.",
		updateCliDev: "Switch to Dev Branch",
		updateCliDevDescription:
			"Get latest development features from jeffersonwarrior/happy-fork",
		updateCliDevUpdating: "Switching to dev branch...",
		updateCliDevSuccess:
			"Switched to dev branch successfully! Session will refresh.",
	...
	settingsAccount: {
		...
		passwordSecurityDescription:
			"Protect your sessions with a password to prevent unauthorized access.",
	...
	sessions: {
		...
		exportSaved: ({ fileName }: { fileName: string }) =>
			`Session history saved as ${fileName}`,
	...
	password: {
		...
		tooManyAttemptsMessage:
			"Too many failed password attempts. Please try biometric authentication or reset the app.",
		...
		anonymousModeDescription:
			"Use temporary credentials without saving account information",
		enableAnonymousMode: "Enable Anonymous Mode",
		anonymousModeEnabled:
			"Anonymous mode enabled. Your session data will not be saved.",
		...
		passwordResetSuccess:
			"Password protection has been removed. You can set up a new password in Settings.",
		useFaceID: "Use Face ID",
		useTouchID: "Use Touch ID",
		biometricRecoveryDescription:
			"Reset password using your biometric authentication",
		useSecretKey: "Use Secret Key",
		secretKeyRecoveryDescription:
			"Restore your account using your backup secret key",
		recoveryFooter:
			"If you need help recovering your account, these options will guide you through the process.",
