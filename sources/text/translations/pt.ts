...
export const pt: TranslationStructure = {
	...
	settingsFeatures: {
		...
		defaultCoderDescription:
			"Escolha qual assistente de IA usar para novas sessões por padrão.",
		defaultCoderClaude: "Claude Code",
		defaultCoderCodex: "Codex",
		defaultCoderAsk: "Perguntar toda vez",
		privacy: "Privacidade",
		privacyDescription:
			"Controle como suas informações pessoais são exibidas e compartilhadas.",
	...
	sessionInfo: {
		...
		updateCliSuccess:
			"CLI atualizado com sucesso! A sessão será atualizada automaticamente.",
		updateCliError:
			"Falha ao atualizar CLI. Por favor, tente a atualização manual.",
		updateCliDev: "Mudar para ramo de desenvolvimento",
		updateCliDevDescription:
			"Obter os recursos de desenvolvimento mais recentes de jeffersonwarrior/happy-fork",
		updateCliDevUpdating: "Mudando para ramo de desenvolvimento...",
		updateCliDevSuccess:
			"Mudado com sucesso para o ramo de desenvolvimento! A sessão será atualizada.",
	...
	settingsAccount: {
		...
		passwordSecurityDescription:
			"Proteja suas sessões com uma senha para prevenir acesso não autorizado.",
	...
	daemonCleanup: {
		...
		couldNotStop: ({ machineName }: { machineName: string }) =>
			`O daemon em "${machineName}" não pôde ser parado.`,
		...
		removeSessionDescription:
			"Limpar o estado da sessão localmente (o daemon pode permanecer em execução)",
		cancelDescription:
			"Manter a sessão como está e tentar novamente mais tarde",
	...
	sessions: {
		...
		exportSaved: ({ fileName }: { fileName: string }) =>
			`Histórico da sessão salvo como ${fileName}`,
		exportFailed: "Falha ao exportar o histórico da sessão",
		exportHistoryComingSoon:
			"O recurso de exportar histórico de sessão estará disponível em breve.",
	},
	...
	password: {
		...
		verificationError:
			"Não foi possível verificar a senha. Por favor, tente novamente.",
		...
		anonymousModeDescription:
			"Usar credenciais temporárias sem salvar informações da conta",
		enableAnonymousMode: "Habilitar modo anônimo",
		anonymousModeEnabled:
			"Modo anônimo habilitado. Os dados da sua sessão não serão salvos.",
		...
		recoveryDescription:
			"Escolha como você gostaria de recuperar o acesso à sua conta",
		...
		passwordResetSuccess:
			"A proteção por senha foi removida. Você pode configurar uma nova senha nas Configurações.",
		useFaceID: "Usar Face ID",
		useTouchID: "Usar Touch ID",
		biometricRecoveryDescription:
			"Redefinir senha usando autenticação biométrica",
		useSecretKey: "Usar chave secreta",
		secretKeyRecoveryDescription:
			"Restaurar sua conta usando sua chave secreta de backup",
		recoveryFooter:
