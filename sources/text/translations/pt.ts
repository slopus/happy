...
export const pt: TranslationStructure = {
    ...
    session: {
        ...
        sharing: {
            ...
            noShares: 'Ainda nao ha compartilhamentos',
            viewOnlyDescription: 'Pode visualizar mensagens e metadados',
            canEditDescription: 'Pode enviar mensagens, mas nao gerenciar compartilhamento',
            canManageDescription: 'Acesso completo incluindo gerenciamento de compartilhamento',
        },
    },
    ...
    sessionSharing: {
        ...
        publicLink: 'Link público',
        publicLinkDescription: 'Crie um link público que qualquer pessoa pode usar para acessar esta sessão. Você pode definir uma data de expiração e um limite de uso.',
        expiresIn: 'Expira em',
        days7: '7 dias',
        days30: '30 dias',
        never: 'Nunca',
        ...
        uses10: '10 usos',
        uses50: '50 usos',
        requireConsent: 'Requer consentimento',
        requireConsentDescription: 'Os usuários devem aceitar os termos antes de acessar',
        linkToken: 'Token do link',
        expiresOn: 'Expira em',
        usageCount: 'Quantidade de usos',
