...
export const pt: TranslationStructure = {
  ...
  settingsFeatures: {
    ...
    aiModelsDescription: 'Modelos de IA descobertos automaticamente e suas capacidades. Toque para atualizar a lista de modelos.',
  ...
  password: {
    ...
    incorrectPasswordMessage: ({ attempts }: { attempts: number }) => `Senha incorreta. ${attempts === 1 ? 'Resta 1 tentativa' : `Restam ${attempts} tentativas`}.`,
    tooManyAttempts: 'Muitas tentativas',
    tooManyAttemptsMessage: 'Muitas tentativas de senha falhadas. Tente autenticação biométrica ou redefina o aplicativo.',
    attemptsRemaining: ({ attempts }: { attempts: number }) => attempts === 1 ? 'Resta 1 tentativa' : `Restam ${attempts} tentativas`,
    ...
    forgotPasswordMessage: 'Esquecer sua senha redefinirá o aplicativo e você precisará restaurar sua conta usando sua chave secreta.',
    ...
    disablePasswordMessage: 'Tem certeza de que deseja desativar a proteção por senha? Suas sessões serão acessíveis sem senha.',
    ...
    resetPasswordBiometric: 'Sua identidade foi verificada. Isso removerá a proteção por senha mantendo seus dados de sessão seguros.',
    resetPassword: 'Redefinir senha',
    resetAppTitle: 'Redefinir aplicativo',
    resetAppWarning: 'Isso excluirá TODOS os seus dados incluindo sessões, configurações e informações da conta. Esta ação não pode ser desfeita.',
    resetAppDescription: 'Remover todos os dados e começar do zero',
    confirmReset: 'Você tem certeza absoluta?',
    confirmResetMessage: 'Isso excluirá tudo permanentemente. Você precisará restaurar sua conta usando sua chave secreta.',
    ...
    recoveryFooter: 'Se você precisar de ajuda para recuperar sua conta, essas opções irão guiá-lo através do processo.',
  ...
  passwordMigration: {
    ...
    description: 'Adicione proteção por senha para manter suas sessões de programação seguras. Seus dados permanecerão privados com desbloqueio biométrico opcional.',
