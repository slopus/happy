...
export const pl: TranslationStructure = {
    ...
    session: {
        ...
        sharing: {
            ...
            shareNotFound: 'Link udostępniania nie został znaleziony lub został cofnięty',
            shareExpired: 'Ten link udostępniania wygasł',
            failedToDecrypt: 'Nie udało się odszyfrować informacji o udostępnieniu',
            consentDescription: 'Akceptując, wyrażasz zgodę na rejestrowanie informacji o Twoim dostępie',
            acceptAndView: 'Zaakceptuj i wyświetl',
            days7: '7 dni',
            days30: '30 dni',
            ...
            publicLinkDescription: 'Utwórz link, który każdy może użyć, aby uzyskać dostęp do tej sesji',
            expiresIn: 'Link wygasa za',
            requireConsentDescription: 'Użytkownicy muszą wyrazić zgodę przed uzyskaniem dostępu',
