...
export const pl: TranslationStructure = {
	...
	settingsFeatures: {
		...
		privacy: "Prywatność",
		privacyDescription:
			"Kontroluj sposób wyświetlania i udostępniania Twoich danych osobowych.",
		anonymousModeDisabled: "Pokaż prawdziwe imię i profil",
		aiModels: "Modele AI",
		aiModelsDescription:
			"Automatycznie wykryte modele AI i ich możliwości. Dotknij, aby odświeżyć listę modeli.",
	...
	sessionInfo: {
		...
		updateCliSuccess:
			"CLI zaktualizowane pomyślnie! Sesja odświeży się automatycznie.",
		updateCliError:
			"Nie udało się zaktualizować CLI. Proszę spróbować ręcznej aktualizacji.",
		updateCliDev: "Przełącz na wersję deweloperską",
		updateCliDevDescription:
			"Uzyskaj najnowsze funkcje deweloperskie z jeffersonwarrior/happy-fork",
		updateCliDevUpdating: "Przełączanie na wersję deweloperską...",
		updateCliDevSuccess:
			"Pomyślnie przełączono na wersję deweloperską! Sesja zostanie odświeżona.",
	...
	settingsAccount: {
		...
		passwordSecurityDescription:
			"Chroń swoje sesje hasłem, aby zapobiec nieautoryzowanemu dostępowi.",
	...
	daemonCleanup: {
		...
		couldNotStop: ({ machineName }: { machineName: string }) =>
			`Demon na "${machineName}" nie mógł zostać zatrzymany.`,
		...
		removeSessionDescription:
			"Wyczyść stan sesji lokalnie (demon może pozostać uruchomiony)",
	...
	sessions: {
		...
		exportSaved: ({ fileName }: { fileName: string }) =>
			`Historia sesji zapisana jako ${fileName}`,
		exportFailed: "Nie udało się wyeksportować historii sesji",
		exportHistoryComingSoon:
			"Funkcja eksportowania historii sesji będzie dostępna wkrótce.",
	},
	...
	password: {
		...
		unlockSessionDescription:
			"Wprowadź hasło, aby uzyskać dostęp do swoich sesji",
		...
		biometricError:
			"Uwierzytelnianie biometryczne nie powiodło się. Spróbuj ponownie.",
		...
		disablePasswordMessage:
			"Czy na pewno chcesz wyłączyć ochronę hasłem? Twoje sesje będą dostępne bez hasła.",
		passwordDisabled: "Ochrona hasłem wyłączona",
		anonymousMode: "Tryb anonimowy",
		anonymousModeDescription:
			"Użyj tymczasowych poświadczeń bez zapisywania informacji o koncie",
		enableAnonymousMode: "Włącz tryb anonimowy",
		anonymousModeEnabled:
			"Tryb anonimowy włączony. Dane twojej sesji nie zostaną zapisane.",
		...
		confirmResetMessage:
			"To trwale usunie wszystko. Będziesz musiał przywrócić konto za pomocą klucza tajnego.",
		yesResetEverything: "Tak, zresetuj wszystko",
		passwordResetSuccess:
			"Ochrona hasłem została usunięta. Możesz ustawić nowe hasło w Ustawieniach.",
		useFaceID: "Użyj Face ID",
		useTouchID: "Użyj Touch ID",
		biometricRecoveryDescription:
			"Zresetuj hasło za pomocą uwierzytelniania biometrycznego",
		useSecretKey: "Użyj klucza tajnego",
		secretKeyRecoveryDescription:
			"Przywróć konto za pomocą zapasowego klucza tajnego",
		recoveryFooter:
			"Jeśli potrzebujesz pomocy w odzyskaniu konta, te opcje poprowadzą cię przez cały proces.",
