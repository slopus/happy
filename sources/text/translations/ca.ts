...
export const ca: TranslationStructure = {
	...
	settingsFeatures: {
		...
		defaultCoderDescription:
			"Tria quin assistent d'IA utilitzar per a noves sessions per defecte.",
		defaultCoderClaude: "Claude Code",
		defaultCoderCodex: "Codex",
		defaultCoderAsk: "Preguntar cada vegada",
		privacy: "Privacitat",
		privacyDescription:
			"Controla com es mostra i comparteix la teva informació personal.",
	...
	sessionInfo: {
		...
		updateCliSuccess:
			"CLI actualitzat amb èxit! La sessió es refrescarà automàticament.",
		updateCliError:
			"Error en actualitzar el CLI. Si us plau, proveu l'actualització manual.",
		updateCliDev: "Canviar a branca de desenvolupament",
		updateCliDevDescription:
			"Obtenir les últimes funcions de desenvolupament de jeffersonwarrior/happy-fork",
		updateCliDevUpdating: "Canviant a branca de desenvolupament...",
		updateCliDevSuccess:
			"Canviat amb èxit a la branca de desenvolupament! La sessió es refrescarà.",
	...
	settingsAccount: {
		...
		passwordSecurityDescription:
			"Protegeix les teves sessions amb una contrasenya per prevenir l'accés no autoritzat.",
		setupPasswordSubtitle:
			"Afegir protecció amb contrasenya a les teves sessions",
	...
	daemonCleanup: {
		...
		couldNotStop: ({ machineName }: { machineName: string }) =>
			`El daemon a "${machineName}" no s'ha pogut aturar.`,
		...
		removeSessionDescription:
			"Netejar l'estat de la sessió localment (el daemon pot continuar executant-se)",
	...
	sessions: {
		...
		duplicatePrefix: ({ originalName }: { originalName: string }) =>
			`Còpia de ${originalName}`,
		sessionIdCopied: "ID de sessió copiat al portapapers",
		failedToCopySessionId: "Error en copiar l'ID de sessió",
		exportSaved: ({ fileName }: { fileName: string }) =>
			`Historial de sessió desat com a ${fileName}`,
		exportFailed: "Error en exportar l'historial de sessió",
		exportHistoryComingSoon:
			"La funció d'exportar l'historial de la sessió estarà disponible aviat.",
	},

	password: {
		// Password-based session unlocking
		unlockSession: "Desbloqueja sessió",
		unlockSessionDescription:
			"Introdueix la teva contrasenya per accedir a les teves sessions",
		...
		verificationError:
			"No s'ha pogut verificar la contrasenya. Si us plau, torna-ho a provar.",
		...
		biometricError:
			"L'autenticació biomètrica ha fallat. Si us plau, torna-ho a provar.",
		...
		setupPasswordDescription:
			"Protegeix les teves sessions amb una contrasenya",
		...
		anonymousModeDescription:
			"Utilitzar credencials temporals sense guardar informació del compte",
		enableAnonymousMode: "Habilitar mode anònim",
		anonymousModeEnabled:
			"Mode anònim habilitat. Les dades de la teva sessió no es guardaran.",
		...
		biometricRecoveryDescription:
			"Restablir contrasenya utilitzant autenticació biomètrica",
		useSecretKey: "Utilitzar clau secreta",
		secretKeyRecoveryDescription:
			"Restaurar el teu compte utilitzant la teva clau secreta de còpia de seguretat",
		recoveryFooter:
			"Si necessites ajuda recuperant el teu compte, aquestes opcions et guiaran a través del procés.",
	...
	artifacts: {
		...
		discardChangesDescription:
			"Tens canvis no desats. Estàs segur que vols descartar-los?",
