...
export const ca: TranslationStructure = {
  ...
  settingsFeatures: {
    ...
    aiModelsDescription: 'Models d\'IA descoberts automàticament i les seves capacitats. Toca per actualitzar la llista de models.',
  ...
  password: {
    ...
    incorrectPasswordMessage: ({ attempts }: { attempts: number }) => `Contrasenya incorrecta. ${attempts === 1 ? 'Queda 1 intent' : `Queden ${attempts} intents`}.`,
    tooManyAttempts: 'Massa intents',
    tooManyAttemptsMessage: 'Massa intents fallits de contrasenya. Prova amb autenticació biomètrica o restableix l\'aplicació.',
    attemptsRemaining: ({ attempts }: { attempts: number }) => attempts === 1 ? 'Queda 1 intent' : `Queden ${attempts} intents`,
    ...
    forgotPasswordMessage: 'Oblidar la teva contrasenya restablirà l\'aplicació i necessitaràs restaurar el teu compte utilitzant la teva clau secreta.',
    ...
    disablePasswordMessage: 'Estàs segur que vols desactivar la protecció amb contrasenya? Les teves sessions seran accessibles sense contrasenya.',
    ...
    resetPasswordBiometric: 'La teva identitat ha estat verificada. Això eliminarà la protecció per contrasenya mantenint les teves dades de sessió segures.',
    resetPassword: 'Restablir contrasenya',
    resetAppTitle: 'Restablir aplicació',
    resetAppWarning: 'Això eliminarà TOTES les teves dades incloent sessions, configuració i informació del compte. Aquesta acció no es pot desfer.',
    resetAppDescription: 'Eliminar totes les dades i començar de nou',
    confirmReset: 'Estàs absolutament segur?',
    confirmResetMessage: 'Això eliminarà tot permanentment. Necessitaràs restaurar el teu compte utilitzant la teva clau secreta.',
    yesResetEverything: 'Sí, restablir tot',
    passwordResetSuccess: 'La protecció per contrasenya ha estat eliminada. Pots configurar una nova contrasenya a Configuració.',
  ...
  passwordMigration: {
    ...
    description: 'Afegeix protecció amb contrasenya per mantenir segures les teves sessions de programació. Les teves dades romandran privades amb desbloqueig biomètric opcional.',
