...
export const ca: TranslationStructure = {
    ...
    session: {
        ...
        sharing: {
            ...
            shareNotFound: 'Enllaç de compartició no trobat o ha estat revocat',
            shareExpired: 'Aquest enllaç de compartició ha caducat',
            failedToDecrypt: 'No s\'ha pogut desxifrar la informació de compartició',
            consentDescription: 'En acceptar, consents el registre de la teva informació d\'accés',
            acceptAndView: 'Acceptar i veure',
            days7: '7 dies',
            days30: '30 dies',
            never: 'Mai caduca',
            uses10: '10 usos',
            ...
            publicLinkDescription: 'Crea un enllaç compartible que qualsevol pot utilitzar per accedir a aquesta sessió',
            expiresIn: 'L\'enllaç caduca en',
            requireConsentDescription: 'Els usuaris han de donar el seu consentiment abans d\'accedir',
