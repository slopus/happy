...
export const es: TranslationStructure = {
    ...
    session: {
        ...
        sharing: {
            ...
            unlimited: 'Ilimitado',
            requireConsent: 'Requerir consentimiento para registro de acceso',
            consentRequired: 'Este enlace requiere tu consentimiento para registrar información de acceso (dirección IP y user agent)',
            ...
            shareNotFound: 'Enlace de compartir no encontrado o ha sido revocado',
            shareExpired: 'Este enlace de compartir ha expirado',
            failedToDecrypt: 'Error al descifrar la informacion de compartir',
            consentDescription: 'Al aceptar, consientes el registro de tu informacion de acceso',
            ...
            uses10: '10 usos',
            uses50: '50 usos',
            maxUsesLabel: 'Usos maximos',
            publicLinkDescription: 'Crea un enlace compartible que cualquiera puede usar para acceder a esta sesion',
            expiresIn: 'El enlace expira en',
            requireConsentDescription: 'Los usuarios deben dar consentimiento antes de acceder',
    ...
    sessionSharing: {
        addShare: 'Agregar compartido',
        publicLink: 'Enlace público',
        publicLinkDescription: 'Crea un enlace público que cualquiera puede usar para acceder a esta sesión. Puedes establecer una fecha de caducidad y un límite de uso.',
        expiresIn: 'Expira en',
        days7: '7 días',
        days30: '30 días',
        never: 'Nunca',
        ...
        requireConsentDescription: 'Los usuarios deben aceptar los términos antes de acceder',
        linkToken: 'Token del enlace',
        expiresOn: 'Expira el',
        ...
        shareNotFound: 'Compartido no encontrado',
        shareExpired: 'Este enlace de compartir ha expirado',
        failedToDecrypt: 'Error al descifrar los datos de la sesión',
        consentRequired: 'Consentimiento requerido',
        sharedBy: 'Compartido por',
        consentDescription: 'El propietario de la sesión requiere tu consentimiento antes de ver',
        acceptAndView: 'Aceptar y ver sesión',
    },
