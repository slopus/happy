...
export const ja: TranslationStructure = {
    ...
    session: {
        ...
        sharing: {
            ...
            shareNotFound: '共有リンクが見つからないか、取り消されました',
            shareExpired: 'この共有リンクは有効期限が切れています',
            failedToDecrypt: '共有情報の復号に失敗しました',
            consentDescription: '承諾すると、あなたのアクセス情報の記録に同意したことになります',
            acceptAndView: '承諾して表示',
            days7: '7日間',
            days30: '30日間',
            never: '無期限',
            uses10: '10回使用',
            uses50: '50回使用',
            maxUsesLabel: '最大使用回数',
            publicLinkDescription: 'このセッションにアクセスするための共有リンクを作成します',
            expiresIn: 'リンクの有効期限',
            requireConsentDescription: 'アクセス前にユーザーの同意が必要です',
            linkToken: 'リンクトークン',
            expiresOn: '有効期限',
            usageCount: '使用回数',
