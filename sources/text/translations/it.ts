...
export const it: TranslationStructure = {
    ...
    session: {
        ...
        sharing: {
            ...
            expiresAt: ({ date }: { date: string }) => `Scade: ${date}`,
            maxUses: ({ count, used }: { count: number; used: number }) => `${used} / ${count} utilizzi`,
            unlimited: 'Illimitato',
            requireConsent: 'Richiedi consenso per la registrazione degli accessi',
            consentRequired: 'Questo link richiede il tuo consenso per registrare le informazioni di accesso (indirizzo IP e user agent)',
            giveConsent: 'Acconsento alla registrazione degli accessi',
            shareWithFriends: 'Condividi solo con amici',
            friendsOnly: 'Solo gli amici possono essere aggiunti',
            noShares: 'Ancora nessuna condivisione',
            viewOnlyDescription: 'Puo visualizzare messaggi e metadati',
            canEditDescription: 'Puo inviare messaggi ma non gestire la condivisione',
            canManageDescription: 'Accesso completo inclusa la gestione della condivisione',
            shareNotFound: 'Link di condivisione non trovato o revocato',
            shareExpired: 'Questo link di condivisione e scaduto',
            failedToDecrypt: 'Impossibile decrittare le informazioni di condivisione',
            consentDescription: 'Accettando, acconsenti alla registrazione delle tue informazioni di accesso',
            ...
            publicLinkDescription: 'Crea un link condivisibile che chiunque puo usare per accedere a questa sessione',
            expiresIn: 'Il link scade tra',
            requireConsentDescription: 'Gli utenti devono dare il consenso prima di accedere',
