...
export const ru: TranslationStructure = {
    ...
    session: {
        ...
        sharing: {
            ...
            shareNotFound: 'Ссылка не найдена или была отозвана',
            shareExpired: 'Срок действия этой ссылки истёк',
            failedToDecrypt: 'Не удалось расшифровать данные доступа',
            consentDescription: 'Принимая, вы соглашаетесь на запись информации о вашем доступе',
            ...
            requireConsentDescription: 'Пользователи должны дать согласие перед доступом',
            linkToken: 'Токен ссылки',
            expiresOn: 'Дата истечения',
            usageCount: 'Использования',
