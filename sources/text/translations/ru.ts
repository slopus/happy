...
export const ru: TranslationStructure = {
	...
	settingsFeatures: {
		...
		defaultCoderDescription:
			"Выберите ИИ-ассистента для новых сессий по умолчанию.",
		defaultCoderClaude: "Claude Code",
		defaultCoderCodex: "Codex",
		defaultCoderAsk: "Спрашивать каждый раз",
		privacy: "Конфиденциальность",
		privacyDescription:
			"Управление отображением и передачей вашей личной информации.",
	...
	sessionInfo: {
		...
		updateCliError:
			"Не удалось обновить CLI. Пожалуйста, попробуйте обновить вручную.",
		updateCliDev: "Переключиться на ветку разработки",
		updateCliDevDescription:
			"Получить последние функции разработки из jeffersonwarrior/happy-fork",
		updateCliDevUpdating: "Переключение на ветку разработки...",
		updateCliDevSuccess:
			"Успешно переключено на ветку разработки! Сессия будет обновлена.",
	...
	settingsAccount: {
		...
		passwordSecurityDescription:
			"Защитите ваши сессии паролем для предотвращения несанкционированного доступа.",
	...
	daemonCleanup: {
		...
		couldNotStop: ({ machineName }: { machineName: string }) =>
			`Демон на "${machineName}" не удалось остановить.`,
		...
		removeSessionDescription:
			"Очистить состояние сессии локально (демон может остаться запущенным)",
	...
	sessions: {
		...
		exportSaved: ({ fileName }: { fileName: string }) =>
			`История сессии сохранена как ${fileName}`,
		exportFailed: "Не удалось экспортировать историю сессии",
		exportHistoryComingSoon:
			"Функция экспорта истории сессии скоро будет доступна.",
	},
	...
	password: {
		...
		biometricError:
			"Биометрическая аутентификация не удалась. Попробуйте еще раз.",
		...
		disablePasswordMessage:
			"Вы уверены, что хотите отключить защиту паролем? Ваши сессии будут доступны без пароля.",
		passwordDisabled: "Защита паролем отключена",
		anonymousMode: "Анонимный режим",
		anonymousModeDescription:
			"Использовать временные учетные данные без сохранения информации об аккаунте",
		enableAnonymousMode: "Включить анонимный режим",
		anonymousModeEnabled:
			"Анонимный режим включен. Данные вашей сессии не будут сохранены.",
		...
		recoveryDescription:
			"Выберите способ восстановления доступа к вашему аккаунту",
		...
		passwordResetSuccess:
			"Защита паролем удалена. Вы можете установить новый пароль в Настройках.",
		useFaceID: "Использовать Face ID",
		useTouchID: "Использовать Touch ID",
		biometricRecoveryDescription:
			"Сбросить пароль с помощью биометрической аутентификации",
		useSecretKey: "Использовать секретный ключ",
		secretKeyRecoveryDescription:
			"Восстановить аккаунт с помощью резервного секретного ключа",
		recoveryFooter:
			"Если вам нужна помощь в восстановлении аккаунта, эти опции проведут вас через весь процесс.",
