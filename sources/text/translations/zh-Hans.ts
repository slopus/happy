...
export const zhHans = {
	...
	sessionInfo: {
		...
		updateCliDevDescription:
			"从 jeffersonwarrior/happy-fork 获取最新的开发功能",
	...
	password: {
		...
		incorrectPasswordMessage: ({ attempts }: { attempts: number }) =>
			`密码错误。剩余${attempts}次尝试机会。`,
		tooManyAttempts: "尝试次数过多",
		tooManyAttemptsMessage:
			"密码尝试失败次数过多。请尝试生物识别认证或重置应用。",
		...
		resetPasswordBiometric:
			"您的身份已验证。这将移除密码保护，同时保持您的会话数据安全。",
		resetPassword: "重置密码",
		resetAppTitle: "重置应用",
		resetAppWarning:
			"这将删除所有数据，包括会话、设置和账户信息。此操作无法撤销。",
	...
	passwordMigration: {
		...
		title: "保护您的会话",
		description:
			"添加密码保护以确保您的编码会话安全。您的数据将保持私密，并可选择生物识别解锁。",
		setupNow: "立即设置",
		learnMore: "了解更多",
		compactTitle: "启用密码保护",
	},
